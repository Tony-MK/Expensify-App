...
const generateMonthMatrix_1 = require("@src/components/DatePicker/CalendarPicker/generateMonthMatrix");
describe('generateMonthMatrix', () => {
    ...
    it('throws an error if month is less than 0', () => {
        expect(() => (0, generateMonthMatrix_1.default)(2022, -1)).toThrow();
    });
    it('throws an error if month is greater than 11', () => {
        expect(() => (0, generateMonthMatrix_1.default)(2022, 12)).toThrow();
    });
    it('throws an error if year is negative', () => {
        expect(() => (0, generateMonthMatrix_1.default)(-1, 0)).toThrow();
    });
    it('returns a matrix with 6 rows and 7 columns for January 2022', () => {
        const matrix = (0, generateMonthMatrix_1.default)(2022, 0);
