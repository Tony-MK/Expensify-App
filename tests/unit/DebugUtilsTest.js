...
describe('DebugUtils', function () {
    ...
    describe('getReasonForShowingRowInLHN', function () {
        ...
        it('returns null when report is not defined', function () {
            var reason = DebugUtils_1.default.getReasonForShowingRowInLHN({ report: undefined, chatReport: reports_1.chatReportR14932, doesReportHaveViolations: false });
        ...
        it('returns correct reason when report has a valid draft comment', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        reason = DebugUtils_1.default.getReasonForShowingRowInLHN({ report: baseReport, chatReport: reports_1.chatReportR14932, doesReportHaveViolations: false });
        ...
        it('returns correct reason when report has one transaction thread with violations', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.sent();
                        reason = DebugUtils_1.default.getReasonForShowingRowInLHN({ report: MOCK_TRANSACTION_REPORT, chatReport: reports_1.chatReportR14932, hasRBR: true, doesReportHaveViolations: true });
        ...
        it('returns correct reason when report has violations', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.sent();
                        reason = DebugUtils_1.default.getReasonForShowingRowInLHN({ report: MOCK_EXPENSE_REPORT, chatReport: reports_1.chatReportR14932, hasRBR: true, doesReportHaveViolations: true });
                        expect(reason).toBe('debug.reasonVisibleInLHN.hasRBR');
                        return [2 /*return*/];
                }
            });
        ...
        it('returns correct reason when report has errors', function () {
            var reason = DebugUtils_1.default.getReasonForShowingRowInLHN({ report: baseReport, chatReport: reports_1.chatReportR14932, hasRBR: true, doesReportHaveViolations: false });
            expect(reason).toBe('debug.reasonVisibleInLHN.hasRBR');
        });
    });
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    reportAction = ((_b = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow(MOCK_IOU_REPORT, reports_1.chatReportR14932, MOCK_REPORT_ACTIONS, {}, undefined, false, reportErrors)) !== null && _b !== void 0 ? _b : {}).reportAction;
