...
describe('versionUpdater', () => {
    ...
    describe('incrementVersion', () => {
        ...
        it('should increment MAJOR even above max level', () => {
            expect(versionUpdater.incrementVersion(`${versionUpdater.MAX_INCREMENTS}.5.1-80`, versionUpdater.SEMANTIC_VERSION_LEVELS.MAJOR)).toStrictEqual(`${versionUpdater.MAX_INCREMENTS + 1}.0.0-0`);
        });
        ...
        it('should increment the MAJOR', () => {
            expect(versionUpdater.incrementVersion(`2.${versionUpdater.MAX_INCREMENTS}.${versionUpdater.MAX_INCREMENTS}-${versionUpdater.MAX_INCREMENTS}`, versionUpdater.SEMANTIC_VERSION_LEVELS.BUILD)).toStrictEqual('3.0.0-0');
        });
    });
