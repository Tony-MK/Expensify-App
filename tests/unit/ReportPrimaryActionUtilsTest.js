    ...
    it('should return ADD_EXPENSE for expense report with no transactions', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [], violations: {}, policy: {}, isChatReportArchived: false })).toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.ADD_EXPENSE);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, isChatReportArchived: false })).toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.SUBMIT);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, isChatReportArchived: false })).toBe('');
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, isChatReportArchived: false })).toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.APPROVE);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, invoiceReceiverPolicy: invoiceReceiverPolicy, isChatReportArchived: false })).toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.PAY);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, invoiceReceiverPolicy: invoiceReceiverPolicy, isChatReportArchived: false })).toBe('');
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, isChatReportArchived: false })).toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.PAY);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, isChatReportArchived: false })).toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.EXPORT_TO_ACCOUNTING);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, isChatReportArchived: false })).not.toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.EXPORT_TO_ACCOUNTING);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('should return REMOVE HOLD for an approver who held the expense', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    _c.sent();
                    expect((0, ReportPrimaryActionUtils_1.getReportPrimaryAction)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, isChatReportArchived: false })).toBe(CONST_1.default.REPORT.PRIMARY_ACTIONS.REMOVE_HOLD);
                    return [2 /*return*/];
            }
        });
    }); });
...
describe('getTransactionThreadPrimaryAction', function () {
    ...
    describe('isMarkAsResolvedReportAction', function () {
        var submitterAccountID = 1;
        var otherUserAccountID = 3;
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        it('should return true for submitter with pending auto rejected expense violation in transactions', function () {
            var _a;
            var report = {
                reportID: REPORT_ID,
                ownerAccountID: submitterAccountID,
            ...
            var result = (0, ReportPrimaryActionUtils_1.isMarkAsResolvedReportAction)(report, reports_1.chatReportR14932, transactions, violations, undefined, reportActions);
            expect(result).toBe(true);
        });
        it('should return true for admin with pending auto rejected expense violation', function () {
            var _a;
            ...
            var result = (0, ReportPrimaryActionUtils_1.isMarkAsResolvedReportAction)(report, reports_1.chatReportR14932, transactions, violations, policy, reportActions);
            expect(result).toBe(true);
        });
        it('should return false for non-submitter non-admin user', function () {
            var _a;
        ...
        it('should return false when no auto rejected expense violations are present', function () {
            var report = {
                reportID: REPORT_ID,
                ownerAccountID: submitterAccountID,
            };
