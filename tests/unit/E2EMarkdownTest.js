...
const compare_1 = require("../e2e/compare/compare");
const markdown_1 = require("../e2e/compare/output/markdown");
const results = {
    main: {
...
describe('markdown formatter', () => {
    it('should format significant changes properly', () => {
        const data = (0, compare_1.compareResults)(results.main, results.delta, { commentLinking: 'ms' });
        const markdown = (0, markdown_1.buildMarkdown)(data, []).join('\nEOF\n\n');
