...
const createOrUpdateStagingDeploy_1 = require("@github/actions/javascript/createOrUpdateStagingDeploy/createOrUpdateStagingDeploy");
...
const PATH_TO_PACKAGE_JSON = path_1.default.resolve(__dirname, '../../package.json');
...
beforeAll(() => {
    ...
    const mockOctokit = {
        ...
        paginate: jest
            .fn()
            .mockImplementation((objectMethod, args) => objectMethod(args).then(({ data }) => data)),
    };
...
const baseMobileExpensifyPRList = [
    `https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/pull/20`,
    `https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/pull/21`,
    `https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/pull/22`,
];
...
// cspell:disable
`**Release Version:** \`${version}\`\r\n**Compare Changes:** https://github.com/${process.env.GITHUB_REPOSITORY}/compare/production...staging\r\n${includeMobileExpensifyCompare ? `**Mobile-Expensify Changes:** https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/compare/production...staging\r\n` : ''}\r\n**This release contains changes from the following pull requests:**\r\n`;
// cspell:enable
const openCheckbox = '- [ ] ';
...
describe('createOrUpdateStagingDeployCash', () => {
    ...
    test('creates new issue when there is none open', async () => {
        ...
        const result = await (0, createOrUpdateStagingDeploy_1.default)();
    ...
    test('creates new issue when there are no Mobile-Expensify PRs', async () => {
        ...
        expect(result).toStrictEqual({
            ...
            html_url: `https://github.com/${process.env.GITHUB_REPOSITORY}/issues/29`,
            assignees: [CONST_1.default.APPLAUSE_BOT],
            body: `${baseExpectedOutput('1.0.2-1', false)}` +
                `${openCheckbox}${basePRList.at(5)}` +
                `${lineBreak}${openCheckbox}${basePRList.at(6)}` +
                `${lineBreak}${openCheckbox}${basePRList.at(7)}${lineBreak}` +
        ...
        test('with NPM_VERSION input, pull requests, and deploy blockers', async () => {
            ...
            expect(result).toStrictEqual({
                ...
                body: `${baseExpectedOutput('1.0.2-2')}` +
                    ...
                    `${lineBreak}${openCheckbox}https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/pull/23` +
                    `${lineBreak}${openCheckbox}https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/pull/24${lineBreak}` +
                    `${lineBreakDouble}${deployBlockerHeader}` +
                    `${lineBreak}${openCheckbox}${basePRList.at(5)}` +
                    `${lineBreak}${openCheckbox}${basePRList.at(8)}` +
    ...
    describe('cherry-pick filtering', () => {
        test('filters out PRs that were already included in previous checklist', async () => {
            ...
            const mockGetStagingDeployCashData = jest.spyOn(GithubUtils_1.default, 'getStagingDeployCashData');
            mockGetStagingDeployCashData.mockImplementation(() => ({
                ...
                PRListMobileExpensify: [
                    { url: `https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/pull/20`, number: 20, isVerified: true },
                    { url: `https://github.com/${CONST_1.default.GITHUB_OWNER}/${CONST_1.default.MOBILE_EXPENSIFY_REPO}/pull/22`, number: 22, isVerified: true },
                ],
                deployBlockers: [],
                internalQAPRList: [],
