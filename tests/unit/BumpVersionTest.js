...
const BUILD_GRADLE_PATH = path_1.default.resolve(__dirname, '../../android/app/build.gradle');
const ANDROID_MANIFEST_PATH = path_1.default.resolve(__dirname, '../../Mobile-Expensify/Android/AndroidManifest.xml');
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
      ...
      xmlns:tools="http://schemas.android.com/tools">
            ...
            await (0, bumpVersion_1.updateAndroid)(versionName);
            const buildGradle = fs_1.default.readFileSync(BUILD_GRADLE_PATH, { encoding: 'utf8' });
            expect(buildGradle).toBe(expectedBuildGradle);
            const androidManifest = fs_1.default.readFileSync(ANDROID_MANIFEST_PATH, { encoding: 'utf8' });
