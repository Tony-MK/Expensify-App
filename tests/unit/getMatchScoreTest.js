...
const getMatchScore_1 = require("../../src/libs/getMatchScore");
describe('getMatchScore', () => {
    test('returns 3 for exact case-sensitive match', () => {
        const result = (0, getMatchScore_1.default)('test', 'test');
    ...
    test('returns 2 for starts-with match', () => {
        const result = (0, getMatchScore_1.default)('testing', 'test');
    ...
    test('returns 1 for contains match in the middle', () => {
        const result = (0, getMatchScore_1.default)('contest', 'test');
        expect(result).toBe(1);
    });
    test('returns 1 for contains match at the end', () => {
        const result = (0, getMatchScore_1.default)('latest', 'test');
        expect(result).toBe(1);
    });
    ...
    test('returns 0 for no match', () => {
        const result = (0, getMatchScore_1.default)('hello', 'test');
        expect(result).toBe(0);
    });
    test('returns 0 for empty string', () => {
        const result = (0, getMatchScore_1.default)('', 'test');
        expect(result).toBe(0);
    });
    test('returns 3 for both empty string and query', () => {
        const result = (0, getMatchScore_1.default)('', '');
        expect(result).toBe(3);
    });
    ...
    test('handles special characters in exact match', () => {
        const result = (0, getMatchScore_1.default)('test@example.com', 'test@example.com');
        expect(result).toBe(3);
    });
    test('handles special characters in starts-with match', () => {
        const result = (0, getMatchScore_1.default)('test@example.com', 'test@');
        expect(result).toBe(2);
    });
    test('handles special characters in contains match', () => {
        const result = (0, getMatchScore_1.default)('user@test.com', 'test');
        expect(result).toBe(1);
    });
    test('handles whitespace in exact match', () => {
        const result = (0, getMatchScore_1.default)('hello world', 'hello world');
        expect(result).toBe(3);
    });
    test('handles whitespace in starts-with match', () => {
        const result = (0, getMatchScore_1.default)('hello world test', 'hello world');
        expect(result).toBe(2);
    });
    test('handles whitespace in contains match', () => {
        const result = (0, getMatchScore_1.default)('test hello world', 'hello world');
        expect(result).toBe(1);
    });
});
