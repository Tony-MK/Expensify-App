...
jest.mock('@libs/DraftCommentUtils', function () { return ({
...
describe('SidebarUtils', function () {
    ...
    describe('getOptionData', function () {
        ...
        describe('Alternative text', function () {
            ...
            it("For policy expense chat whose last action is a report preview linked to an expense report with non-reimbursable transaction the LHN text should be in the format 'spent $total'", function () { return __awaiter(void 0, void 0, void 0, function () {
                var policy, policyExpenseChat, reportNameValuePairs, lastReportPreviewAction, policyExpenseChatActions, iouReport, iouAction, iouReportActions, transaction, optionData, totalDisplaySpend, formattedAmount;
                var _a, _b;
                var _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            policy = __assign(__assign({}, (0, policies_1.default)(1)), { role: CONST_1.default.POLICY.ROLE.ADMIN, pendingAction: null });
                            policyExpenseChat = __assign(__assign({}, (0, reports_2.createRandomReport)(2)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_EXPENSE_CHAT, policyID: policy.id, policyName: policy.name, type: CONST_1.default.REPORT.TYPE.CHAT });
                            reportNameValuePairs = {};
                        ...
                        case 5:
                            ...
                            totalDisplaySpend = (0, ReportUtils_1.getMoneyRequestSpendBreakdown)(iouReport).totalDisplaySpend;
                            formattedAmount = (0, CurrencyUtils_1.convertToDisplayString)(totalDisplaySpend, iouReport.currency);
                            expect(optionData === null || optionData === void 0 ? void 0 : optionData.alternateText).toBe((0, ReportUtils_1.formatReportLastMessageText)((0, Localize_1.translateLocal)('iou.payerSpentAmount', { payer: (_c = (0, ReportUtils_1.getDisplayNameForParticipant)({ accountID: iouReport.ownerAccountID })) !== null && _c !== void 0 ? _c : '', amount: formattedAmount })));
                            return [2 /*return*/];
                    }
                });
            }); });
                    ...
                    switch (_e.label) {
                        case 0:
                            ...
                            MOCK_REPORT_ACTIONS = (_b = {},
                                ...
                                _b);
                            return [4 /*yield*/, react_native_onyx_1.default.multiSet(__assign(__assign((_c = {}, _c[ONYXKEYS_1.default.SESSION] = {
                                    accountID: 12345,
                                }, _c), MOCK_REPORTS), (_d = {}, _d["".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(MOCK_REPORT.reportID)] = MOCK_REPORT_ACTIONS, _d)))];
                        case 1:
                            _e.sent();
                            result = SidebarUtils_1.default.getOptionData({
                                report: MOCK_REPORT,
    ...
    describe('sortReportsToDisplayInLHN', function () {
        describe('categorizeReportsForLHN', function () {
            it('should categorize reports into correct groups', function () {
                ...
                var hasValidDraftComment = require('@libs/DraftCommentUtils').hasValidDraftComment;
                hasValidDraftComment.mockImplementation(function (reportID) { return reportID === '2'; });
                var _f = (0, sidebarReports_1.createSidebarTestData)(), reports = _f.reports, reportNameValuePairs = _f.reportNameValuePairs, reportAttributes = _f.reportAttributes;
                // When the reports are categorized
                var result = SidebarUtils_1.default.categorizeReportsForLHN(reports, reportNameValuePairs, reportAttributes);
                ...
                expect((_b = result.errorReports.at(0)) === null || _b === void 0 ? void 0 : _b.reportID).toBe('1');
                expect(result.draftReports).toHaveLength(1);
                expect((_c = result.draftReports.at(0)) === null || _c === void 0 ? void 0 : _c.reportID).toBe('2');
                expect(result.nonArchivedReports).toHaveLength(1);
                expect((_d = result.nonArchivedReports.at(0)) === null || _d === void 0 ? void 0 : _d.reportID).toBe('3');
                expect(result.archivedReports).toHaveLength(1);
                expect((_e = result.archivedReports.at(0)) === null || _e === void 0 ? void 0 : _e.reportID).toBe('4');
            });
            it('should handle reports with requiresAttention flag', function () {
                ...
                // When the reports are categorized
                var result = SidebarUtils_1.default.categorizeReportsForLHN(reports, undefined, reportAttributes);
                // Then the reports are categorized into the correct groups
                expect(result.pinnedAndGBRReports).toHaveLength(1);
                expect((_a = result.pinnedAndGBRReports.at(0)) === null || _a === void 0 ? void 0 : _a.reportID).toBe('0');
            });
            it('should process reports with empty reportID', function () {
                ...
                reports['1'] = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { reportID: '', reportName: 'Invalid Report', isPinned: false, hasErrorsOtherThanFailedReceipt: false });
                // When the reports are categorized
        ...
        describe('sortReportsToDisplayInLHN', function () {
            it('should sort reports correctly', function () {
                ...
                // When the reports are sorted
                var result = SidebarUtils_1.default.sortReportsToDisplayInLHN(reports, priorityMode, mockLocaleCompare);
            ...
            it('should handle different priority modes correctly', function () {
                ...
                var defaultResult = SidebarUtils_1.default.sortReportsToDisplayInLHN(reports, CONST_1.default.PRIORITY_MODE.DEFAULT, mockLocaleCompare);
                // When the reports are sorted in GSD mode
                var gsdResult = SidebarUtils_1.default.sortReportsToDisplayInLHN(reports, CONST_1.default.PRIORITY_MODE.GSD, mockLocaleCompare);
                // Then the reports are sorted in the correct order
