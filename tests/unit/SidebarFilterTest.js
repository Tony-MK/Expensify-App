    ...
    describe('in default (most recent) mode', () => {
        it('excludes a report with no participants', () => {
            ...
            return ((0, waitForBatchedUpdates_1.default)()
                ...
                .then(() => react_native_onyx_1.default.multiSet(reportCollectionDataSet))
                // Then no reports are rendered in the LHN
                .then(() => {
                const optionRows = react_native_1.screen.queryAllByAccessibilityHint((0, TestHelper_1.getNavigateToChatHintRegex)());
        ...
        it('includes or excludes default policy rooms depending on the beta', () => {
            ...
            return ((0, waitForBatchedUpdates_1.default)()
                ...
                .then(() => react_native_onyx_1.default.multiSet({
                [ONYXKEYS.BETAS]: [CONST_1.default.BETAS.DEFAULT_ROOMS],
            }))
        ...
        it('includes default policy rooms for free policies, regardless of the beta', () => {
            ...
            return ((0, waitForBatchedUpdates_1.default)()
                ...
                .then(() => react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.POLICY}${policy.policyID}`, { type: CONST_1.default.POLICY.TYPE.CORPORATE }))
        ...
        it('filter paycheck and bill report', () => {
            const report1 = {
                ...LHNTestUtils.getFakeReport(),
                type: CONST_1.default.REPORT.UNSUPPORTED_TYPE.PAYCHECK,
            };
            const report2 = {
                ...LHNTestUtils.getFakeReport(),
                type: CONST_1.default.REPORT.UNSUPPORTED_TYPE.BILL,
                errorFields: {
                    notFound: {
            ...
            for (let i = 0; i < 1 << AMOUNT_OF_VARIABLES; i++) {
                ...
                it(`the booleans ${JSON.stringify(boolArr)}`, () => {
                    ...
                    return ((0, waitForBatchedUpdates_1.default)()
                        // When Onyx is updated to contain that data and the sidebar re-renders
                        .then(() => react_native_onyx_1.default.multiSet({
                        [ONYXKEYS.NVP_PRIORITY_MODE]: CONST_1.default.PRIORITY_MODE.GSD,
                        ...
                        if (booleansWhichRemovesActiveReport.indexOf(JSON.stringify(boolArr)) > -1) {
                            ...
                            const displayNamesHintText = (0, Localize_1.translateLocal)('accessibilityHints.chatUserDisplayNames');
                            const displayNames = react_native_1.screen.queryAllByLabelText(displayNamesHintText);
    ...
    describe('in #focus mode', () => {
        it('hides unread chats', () => {
            ...
            return ((0, waitForBatchedUpdates_1.default)()
                ...
                return react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${report3.reportID}`, { lastVisibleActionCreated: DateUtils_1.default.getDBTime() });
            })
                ...
                .then(() => react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${report1.reportID}`, { lastReadTime: DateUtils_1.default.getDBTime() }))
        ...
        it('archived rooms are displayed only when they have unread messages', () => {
            ...
            return ((0, waitForBatchedUpdates_1.default)()
                ...
                .then(() => {
                jest.advanceTimersByTime(10);
                return react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${archivedReport.reportID}`, {
                    lastVisibleActionCreated: DateUtils_1.default.getDBTime(),
                });
            })
                .then(() => react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${archivedPolicyRoomReport.reportID}`, {
                lastVisibleActionCreated: DateUtils_1.default.getDBTime(),
            }))
                .then(() => react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${archivedUserCreatedPolicyRoomReport.reportID}`, {
                lastVisibleActionCreated: DateUtils_1.default.getDBTime(),
            }))
        ...
        it('policy rooms are displayed only when they have unread messages', () => {
            ...
            return ((0, waitForBatchedUpdates_1.default)()
                ...
                .then(() => {
                jest.advanceTimersByTime(10);
                return react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${policyRoomReport.reportID}`, {
                    lastVisibleActionCreated: DateUtils_1.default.getDBTime(),
                });
            })
                .then(() => react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${userCreatedPolicyRoomReport.reportID}`, {
                lastVisibleActionCreated: DateUtils_1.default.getDBTime(),
            }))
        ...
        describe('in default (most recent) mode', () => {
            it('is shown regardless if it has comments or not', () => {
                ...
                return ((0, waitForBatchedUpdates_1.default)()
                    // When Onyx is updated to contain that data and the sidebar re-renders
                    .then(() => react_native_onyx_1.default.multiSet({
                    [ONYXKEYS.NVP_PRIORITY_MODE]: CONST_1.default.PRIORITY_MODE.DEFAULT,
                    [ONYXKEYS.BETAS]: betas,
                    [ONYXKEYS.PERSONAL_DETAILS_LIST]: LHNTestUtils.fakePersonalDetails,
                    [ONYXKEYS.IS_LOADING_APP]: false,
                    ...reportCollectionDataSet,
                    ...
                    .then(() => react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${report.reportID}`, {
                    lastVisibleActionCreated: DateUtils_1.default.getDBTime(),
                }))
                    // Then the report is rendered in the LHN
                    .then(() => {
        ...
        describe('in GSD (focus) mode', () => {
            it('is shown when it is unread', () => {
                ...
                return ((0, waitForBatchedUpdates_1.default)()
                    ...
                    .then(() => {
                    jest.advanceTimersByTime(10);
                    return react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${report.reportID}`, { lastVisibleActionCreated: DateUtils_1.default.getDBTime() });
                })
                    // Then the report is rendered in the LHN
                    .then(() => {
                    const optionRows = react_native_1.screen.queryAllByAccessibilityHint((0, TestHelper_1.getNavigateToChatHintRegex)());
            ...
            it('is shown when it is pinned', () => {
                ...
                return ((0, waitForBatchedUpdates_1.default)()
                    ...
                    .then(() => react_native_onyx_1.default.merge(`${ONYXKEYS.COLLECTION.REPORT}${report.reportID}`, { isPinned: true }))
                    // Then the report is rendered in the LHN
                    .then(() => {
                    const optionRows = react_native_1.screen.queryAllByAccessibilityHint((0, TestHelper_1.getNavigateToChatHintRegex)());
                    expect(optionRows).toHaveLength(1);
