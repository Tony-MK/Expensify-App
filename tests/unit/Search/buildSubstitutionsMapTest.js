...
const buildSubstitutionsMap_1 = require("@src/components/Search/SearchRouter/buildSubstitutionsMap");
...
const reportsMock = {
    [`${ONYXKEYS_1.default.COLLECTION.REPORT}rep123`]: {
        reportID: 'rep123',
        reportName: 'Report 1',
    },
    [`${ONYXKEYS_1.default.COLLECTION.REPORT}rep456`]: {
        reportID: 'rep456',
        reportName: 'Report 2',
    },
};
...
const cardFeedMock = 'oauth.americanexpressfdx.com 1001';
const cardFeedsMock = {
...
describe('buildSubstitutionsMap should return correct substitutions map', () => {
    test('when there were no substitutions', () => {
        ...
        const result = (0, buildSubstitutionsMap_1.buildSubstitutionsMap)(userQuery, personalDetailsMock, reportsMock, taxRatesMock, {}, cardFeedsMock, {});
    ...
    test('when query has multiple substitutions of different types', () => {
        ...
        const result = (0, buildSubstitutionsMap_1.buildSubstitutionsMap)(userQuery, personalDetailsMock, reportsMock, taxRatesMock, cardListMock, cardFeedsMock, {});
        expect(result).toStrictEqual({
            'from:Jane Doe': '78901',
            'from:John Doe': '12345',
            'in:Report 1': 'rep123',
