...
const cardFeedAmericaExpressMock = 'oauth.americanexpressfdx.com 1001';
const cardFeedVisaMock = 'vcf';
const cardFeedCitiBankMock = 'oauth.citibank.com';
const cardFeedStripeMock = 'stripe';
const cardFeedsMock = {
...
describe('Card Feed Utils', () => {
    ...
    it('returns display name of workspace & domain cards', () => {
        const cardFeedNamesWithType = (0, CardFeedUtils_1.getCardFeedNamesWithType)({ workspaceCardFeeds: fakeWorkspace, translate: Localize_1.translateLocal });
    ...
    it('returns feeds to selected cards', () => {
        ...
        const selected = (0, CardFeedUtils_1.getSelectedCardsFromFeeds)({}, fakeWorkspace, feeds);
        expect(selected.length).toBe(1);
        expect(selected.at(0)).toEqual('33333333');
    });
    it('returns empty object when workspaceCardFeeds is empty', () => {
        const names = (0, CardFeedUtils_1.getCardFeedNamesWithType)({ workspaceCardFeeds: { key: {} }, translate: Localize_1.translateLocal });
    ...
    it('returns card feeds for display with custom names', () => {
        const cardFeedsForDisplay = (0, CardFeedUtils_1.getCardFeedsForDisplay)(cardFeedsMock, cardListMock);
    ...
    it('returns card feeds for display without Expensify Card', () => {
        const cardFeedsForDisplay = (0, CardFeedUtils_1.getCardFeedsForDisplay)(cardFeedsMock, {});
        expect(cardFeedsForDisplay).toEqual({
            '1234_oauth.americanexpressfdx.com 1001': { id: '1234_oauth.americanexpressfdx.com 1001', fundID: '1234', feed: 'oauth.americanexpressfdx.com 1001', name: 'American Express' },
            '1234_vcf': { id: '1234_vcf', fundID: '1234', feed: 'vcf', name: 'Custom feed name' },
            '1234_oauth.citibank.com': { id: '1234_oauth.citibank.com', fundID: '1234', feed: 'oauth.citibank.com', name: 'Citibank' },
    ...
    it('returns card feeds grouped per policy', () => {
        const cardFeedsForDisplayPerPolicy = (0, CardFeedUtils_1.getCardFeedsForDisplayPerPolicy)(cardFeedsMock);
