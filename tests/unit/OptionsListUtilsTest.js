...
describe('OptionsListUtils', () => {
    ...
    const PERSONAL_DETAILS_WITH_MANAGER_MCTEST = {
        ...PERSONAL_DETAILS,
        '1003': {
            accountID: 1003,
    ...
    beforeAll(() => {
        react_native_onyx_1.default.init({
            ...
            initialKeyStates: {
                [ONYXKEYS_1.default.SESSION]: { accountID: 2, email: 'tonystark@expensify.com' },
                [`${ONYXKEYS_1.default.COLLECTION.REPORT}100`]: {
                    reportID: '',
                    ownerAccountID: 8,
                    total: 1000,
                },
                [`${ONYXKEYS_1.default.COLLECTION.POLICY}${policyID}`]: POLICY,
                [ONYXKEYS_1.default.NVP_ACTIVE_POLICY_ID]: activePolicyID,
                [ONYXKEYS_1.default.NVP_DISMISSED_PRODUCT_TRAINING]: {},
            },
        });
        react_native_onyx_1.default.registerLogger(() => { });
        return (0, waitForBatchedUpdates_1.default)().then(() => react_native_onyx_1.default.set(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, PERSONAL_DETAILS));
    });
    let OPTIONS;
    let OPTIONS_WITH_CONCIERGE;
    let OPTIONS_WITH_CHRONOS;
    let OPTIONS_WITH_RECEIPTS;
    let OPTIONS_WITH_WORKSPACE_ROOM;
    let OPTIONS_WITH_MANAGER_MCTEST;
    beforeEach(() => {
        react_native_onyx_1.default.set(`${ONYXKEYS_1.default.COLLECTION.REPORT_NAME_VALUE_PAIRS}10`, reportNameValuePairs);
    ...
    describe('getSearchOptions()', () => {
        it('should return all options when no search value is provided', () => {
            ...
            const results = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS, [CONST_1.default.BETAS.ALL]);
        ...
        it('should include current user when includeCurrentUser is true for type:chat from suggestions', () => {
            ...
            const results = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS, [CONST_1.default.BETAS.ALL], true, true, '', undefined, false, true, true);
        ...
        it('should exclude current user when includeCurrentUser is false', () => {
            ...
            const results = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS, [CONST_1.default.BETAS.ALL], true, true, '', undefined, false, true, false);
    ...
    describe('orderOptions()', () => {
        it('should sort options alphabetically and preserves reportID for personal details with existing reports', () => {
            ...
            let results = (0, OptionsListUtils_1.getValidOptions)({
        ...
        it('should sort personal details options alphabetically when only personal details are provided', () => {
            ...
            let results = (0, OptionsListUtils_1.getValidOptions)({ personalDetails: OPTIONS.personalDetails, reports: [] });
            // When we call orderOptions()
            results = (0, OptionsListUtils_1.orderOptions)(results);
            const expected = [
                'Black Panther',
    ...
    describe('getValidOptions()', () => {
        it('should return empty options when no reports or personal details are provided', () => {
            ...
            // When we call getValidOptions()
            const results = (0, OptionsListUtils_1.getValidOptions)({ reports: [], personalDetails: [] });
        ...
        it('should include Concierge by default in results', () => {
            ...
            // When we call getValidOptions()
            const results = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS_WITH_CONCIERGE.reports, personalDetails: OPTIONS_WITH_CONCIERGE.personalDetails });
        ...
        it('should exclude Concierge when excludedLogins is specified', () => {
            ...
            // When we call getValidOptions()
            const results = (0, OptionsListUtils_1.getValidOptions)({
                reports: OPTIONS_WITH_CONCIERGE.reports,
                personalDetails: OPTIONS_WITH_CONCIERGE.personalDetails,
            }, {
                excludeLogins: { [CONST_1.default.EMAIL.CONCIERGE]: true },
            });
        ...
        it('should exclude Chronos when excludedLogins is specified', () => {
            ...
            // When we call getValidOptions()
            const results = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS_WITH_CHRONOS.reports, personalDetails: OPTIONS_WITH_CHRONOS.personalDetails }, { excludeLogins: { [CONST_1.default.EMAIL.CHRONOS]: true } });
        ...
        it('should exclude Receipts option from results when excludedLogins is specified', () => {
            ...
            const results = (0, OptionsListUtils_1.getValidOptions)({
                ...
                excludeLogins: { [CONST_1.default.EMAIL.RECEIPTS]: true },
            });
        ...
        it('should include Manager McTest in results by default', () => {
            ...
            // When we call getValidOptions()
            const result = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS_WITH_MANAGER_MCTEST.reports, personalDetails: OPTIONS_WITH_MANAGER_MCTEST.personalDetails }, { includeP2P: true, canShowManagerMcTest: true, betas: [CONST_1.default.BETAS.NEWDOT_MANAGER_MCTEST] });
            // Then the result should include all personalDetails except the currently logged in user
        ...
        it('should exclude Manager McTest from results if flag is set to false', () => {
            ...
            // When we call getValidOptions()
            const result = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS_WITH_MANAGER_MCTEST.reports, personalDetails: OPTIONS_WITH_MANAGER_MCTEST.personalDetails }, { includeP2P: true, canShowManagerMcTest: false, betas: [CONST_1.default.BETAS.NEWDOT_MANAGER_MCTEST] });
        ...
        it('should exclude Manager McTest from results if user dismissed the tooltip', () => {
            ...
            react_native_onyx_1.default.set(ONYXKEYS_1.default.NVP_DISMISSED_PRODUCT_TRAINING, {
                [CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.SCAN_TEST_TOOLTIP]: {
                    timestamp: DateUtils_1.default.getDBTime(new Date().valueOf()),
                },
            }))
                .then(() => {
                // When we call getValidOptions()
                const optionsWhenUserAlreadySubmittedExpense = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS_WITH_MANAGER_MCTEST.reports, personalDetails: OPTIONS_WITH_MANAGER_MCTEST.personalDetails }, { includeP2P: true, canShowManagerMcTest: true, betas: [CONST_1.default.BETAS.NEWDOT_MANAGER_MCTEST] });
                // Then the result should include all personalDetails except the currently logged in user and Manager McTest
        ...
        it('should keep admin rooms if specified', () => {
            ...
            const results = (0, OptionsListUtils_1.getValidOptions)({ reports: [adminRoom], personalDetails: OPTIONS.personalDetails }, {
        ...
        it('should include brickRoadIndicator if showRBR is true', () => {
            ...
            const results = (0, OptionsListUtils_1.getValidOptions)({ reports: [workspaceChat], personalDetails: [] }, {
                includeMultipleParticipantReports: true,
                showRBR: true,
            });
            expect(results.recentReports.at(0)?.brickRoadIndicator).toBe(CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR);
        });
    ...
    describe('getValidOptions() for chat room', () => {
        it('should include all reports by default', () => {
            ...
            // When we call getValidOptions()
            const results = (0, OptionsListUtils_1.getValidOptions)(OPTIONS_WITH_WORKSPACE_ROOM, {
    ...
    describe('getValidOptions() for group Chat', () => {
        it('should exclude users with recent reports from personalDetails', () => {
            ...
            const results = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
        ...
        it('should exclude selected options', () => {
            ...
            const results = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails }, { excludeLogins: { 'peterparker@expensify.com': true } });
    ...
    describe('getShareDestinationsOptions()', () => {
        it('should exclude archived rooms and hidden threads from share destinations', () => {
            ...
            const results = (0, OptionsListUtils_1.getShareDestinationOptions)(filteredReports, OPTIONS.personalDetails, []);
        ...
        it('should include DMS, group chats, and workspace rooms in share destinations', () => {
            ...
            // When we call getShareDestinationOptions with an empty search value
            const results = (0, OptionsListUtils_1.getShareDestinationOptions)(filteredReportsWithWorkspaceRooms, OPTIONS.personalDetails, []);
    ...
    describe('getShareLogOptions()', () => {
        it('should not include read-only report', () => {
            ...
            const results = (0, OptionsListUtils_1.getShareLogOptions)(OPTIONS, []);
    ...
    describe('getMemberInviteOptions()', () => {
        it('should sort personal details alphabetically', () => {
            ...
            const results = (0, OptionsListUtils_1.getMemberInviteOptions)(OPTIONS.personalDetails, []);
    ...
    describe('getLastActorDisplayName()', () => {
        it('should return correct display name', () => {
            ...
            const result1 = (0, OptionsListUtils_1.getLastActorDisplayName)(PERSONAL_DETAILS['2']);
            const result2 = (0, OptionsListUtils_1.getLastActorDisplayName)(PERSONAL_DETAILS['3']);
    ...
    describe('formatMemberForList()', () => {
        it('should format members correctly', () => {
            ...
            const formattedMembers = Object.values(PERSONAL_DETAILS).map((personalDetail) => (0, OptionsListUtils_1.formatMemberForList)(personalDetail));
    ...
    describe('filterAndOrderOptions()', () => {
        it('should return all options when search is empty', () => {
            // Given a set of options
            // When we call getSearchOptions with all betas
            const options = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS, [CONST_1.default.BETAS.ALL]);
            // When we pass the returned options to filterAndOrderOptions with an empty search value
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, '', COUNTRY_CODE);
        ...
        it('should return filtered options in correct order', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE, { sortByReportTypeInSearch: true });
        ...
        it('should filter users by email', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE);
        ...
        it('should filter options by email if dot is skipped in the email', () => {
            ...
            const OPTIONS_WITH_PERIODS = (0, OptionsListUtils_1.createOptionList)(PERSONAL_DETAILS_WITH_PERIODS, REPORTS);
            // When we call getSearchOptions with all betas
            const options = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS_WITH_PERIODS, [CONST_1.default.BETAS.ALL]);
            // When we pass the returned options to filterAndOrderOptions with a search value and sortByReportTypeInSearch param
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE, { sortByReportTypeInSearch: true });
            // Then only one report should be returned
            expect(filteredOptions.recentReports.length).toBe(1);
        ...
        it('should include workspace rooms in the search results', () => {
            ...
            // When we call getSearchOptions with all betas
            const options = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS_WITH_WORKSPACE_ROOM, [CONST_1.default.BETAS.ALL]);
            // When we pass the returned options to filterAndOrderOptions with a search value
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE);
            // Then only one report should be returned
            expect(filteredOptions.recentReports.length).toBe(1);
        ...
        it('should prioritize options with matching display name over chat rooms', () => {
            ...
            const OPTIONS_WITH_CHAT_ROOMS = (0, OptionsListUtils_1.createOptionList)(PERSONAL_DETAILS, REPORTS_WITH_CHAT_ROOM);
            // When we call getSearchOptions with all betas
            const options = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS_WITH_CHAT_ROOMS, [CONST_1.default.BETAS.ALL]);
            // When we pass the returned options to filterAndOrderOptions with a search value
            const filterOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE);
        ...
        it('should put the item with latest lastVisibleActionCreated on top when search value match multiple items', () => {
            ...
            // Given a set of options
            const options = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS);
        ...
        it('should not return any results if the search value is on an excluded logins list', () => {
            ...
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails }, { excludeLogins: CONST_1.default.EXPENSIFY_EMAILS_OBJECT });
            // When we call filterAndOrderOptions with a search value and excluded logins list
            const filterOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE, { excludeLogins: CONST_1.default.EXPENSIFY_EMAILS_OBJECT });
        ...
        it('should return the user to invite when the search value is a valid, non-existent email and the user is not excluded', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE, { excludeLogins: CONST_1.default.EXPENSIFY_EMAILS_OBJECT });
            // Then the user to invite should be returned
            expect(filteredOptions.userToInvite?.login).toBe(searchText);
        });
        it('should return limited amount of recent reports if the limit is set', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE, { maxRecentReportsToShow: 2 });
            // Then only two reports should be returned
            ...
            const limitToZeroOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchText, COUNTRY_CODE, { maxRecentReportsToShow: 0 });
        ...
        it('should not return any options if search value does not match any personal details (getMemberInviteOptions)', () => {
            // Given a set of options
            const options = (0, OptionsListUtils_1.getMemberInviteOptions)(OPTIONS.personalDetails, []);
            // When we call filterAndOrderOptions with a search value that does not match any personal details
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'magneto', COUNTRY_CODE);
            // Then no personal details should be returned
            expect(filteredOptions.personalDetails.length).toBe(0);
        });
        it('should return one personal detail if search value matches an email (getMemberInviteOptions)', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'peterparker@expensify.com', COUNTRY_CODE);
        ...
        it('should not show any recent reports if a search value does not match the group chat name (getShareDestinationsOptions)', () => {
            ...
            const options = (0, OptionsListUtils_1.getShareDestinationOptions)(filteredReports, OPTIONS.personalDetails, []);
            // When we pass the returned options to filterAndOrderOptions with a search value that does not match the group chat name
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'mutants', COUNTRY_CODE);
        ...
        it('should return a workspace room when we search for a workspace room(getShareDestinationsOptions)', () => {
            ...
            // When we call getShareDestinationOptions with the filteredReports
            const options = (0, OptionsListUtils_1.getShareDestinationOptions)(filteredReportsWithWorkspaceRooms, OPTIONS.personalDetails, []);
            // When we pass the returned options to filterAndOrderOptions with a search value that matches the group chat name
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'Avengers Room', COUNTRY_CODE);
        ...
        it('should not show any results if searching for a non-existing workspace room(getShareDestinationOptions)', () => {
            ...
            const options = (0, OptionsListUtils_1.getShareDestinationOptions)(filteredReportsWithWorkspaceRooms, OPTIONS.personalDetails, []);
            // When we pass the returned options to filterAndOrderOptions with a search value that does not match the group chat name
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'Mutants Lair', COUNTRY_CODE);
            // Then no recent reports should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
        });
        it('should show the option from personal details when searching for personal detail with no existing report', () => {
            // Given a set of options
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
            // When we call filterAndOrderOptions with a search value that matches a personal detail with no existing report
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'hulk', COUNTRY_CODE);
            // Then no recent reports should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
            // Then one personal detail should be returned
            expect(filteredOptions.personalDetails.length).toBe(1);
        ...
        it('should not return any options or user to invite if there are no search results and the string does not match a potential email or phone', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'marc@expensify', COUNTRY_CODE);
        ...
        it('should not return any options but should return an user to invite if no matching options exist and the search value is a potential email', () => {
            ...
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'marc@expensify.com', COUNTRY_CODE);
            // Then no recent reports or personal details should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
            expect(filteredOptions.personalDetails.length).toBe(0);
        ...
        it('should return user to invite when search term has a period with options for it that do not contain the period', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'peter.parker@expensify.com', COUNTRY_CODE);
            // Then no recent reports should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
        ...
        it('should return user which has displayName with accent mark when search value without accent mark', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'Timothee', COUNTRY_CODE);
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number', () => {
            ...
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, '5005550006', COUNTRY_CODE);
            // Then no recent reports or personal details should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
            expect(filteredOptions.personalDetails.length).toBe(0);
            // Then one user to invite should be returned
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number with country code added', () => {
            ...
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, '+15005550006', COUNTRY_CODE);
            // Then no recent reports or personal details should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
            expect(filteredOptions.personalDetails.length).toBe(0);
            // Then one user to invite should be returned
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number with special characters added', () => {
            ...
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, '+1 (800)324-3233', COUNTRY_CODE);
            // Then no recent reports or personal details should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
            expect(filteredOptions.personalDetails.length).toBe(0);
            // Then one user to invite should be returned
        ...
        it('should not return any options or user to invite if contact number contains alphabet characters', () => {
            ...
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, '998243aaaa', COUNTRY_CODE);
            // Then no recent reports or personal details should be returned
            expect(filteredOptions.recentReports.length).toBe(0);
            expect(filteredOptions.personalDetails.length).toBe(0);
            // Then no user to invite should be returned
        ...
        it('should return one recent report and no personal details if a search value provides an email', () => {
            ...
            const options = (0, OptionsListUtils_1.getValidOptions)({ reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails });
            // When we call filterAndOrderOptions with a search value that matches an email
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'peterparker@expensify.com', COUNTRY_CODE, { sortByReportTypeInSearch: true });
            // Then one recent report should be returned
            expect(filteredOptions.recentReports.length).toBe(1);
        ...
        it('should return all matching reports and personal details', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, '.com', COUNTRY_CODE, { maxRecentReportsToShow: 5 });
        ...
        it('should return matching option when searching (getSearchOptions)', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'spider', COUNTRY_CODE);
            // Then one personal detail should be returned
            expect(filteredOptions.recentReports.length).toBe(1);
            // Then the returned personal detail should match the search text
            expect(filteredOptions.recentReports.at(0)?.text).toBe('Spider-Man');
        ...
        it('should return latest lastVisibleActionCreated item on top when search value matches multiple items (getSearchOptions)', () => {
            ...
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, 'fantastic', COUNTRY_CODE);
            // Then only three reports should be returned
            expect(filteredOptions.recentReports.length).toBe(3);
            // Then the first report should match the search text
            expect(filteredOptions.recentReports.at(0)?.text).toBe('Mister Fantastic');
            ...
            expect(filteredOptions.recentReports.at(1)?.text).toBe('Mister Fantastic, Invisible Woman');
            return (0, waitForBatchedUpdates_1.default)()
                .then(() => react_native_onyx_1.default.set(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, PERSONAL_DETAILS_WITH_PERIODS))
                .then(() => {
                // Given a set of options with periods
                const OPTIONS_WITH_PERIODS = (0, OptionsListUtils_1.createOptionList)(PERSONAL_DETAILS_WITH_PERIODS, REPORTS);
                // When we call getSearchOptions
                const results = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS_WITH_PERIODS);
                // When we pass the returned options to filterAndOrderOptions with a search value
                const filteredResults = (0, OptionsListUtils_1.filterAndOrderOptions)(results, 'barry.allen@expensify.com', COUNTRY_CODE, { sortByReportTypeInSearch: true });
                // Then only one report should be returned
        ...
        it('should order self dm always on top if the search matches with the self dm login', () => {
            ...
            const OPTIONS_WITH_SELF_DM = (0, OptionsListUtils_1.createOptionList)(PERSONAL_DETAILS, REPORTS_WITH_SELF_DM);
            // Given a set of options with self dm and all betas
            const options = (0, OptionsListUtils_1.getSearchOptions)(OPTIONS_WITH_SELF_DM, [CONST_1.default.BETAS.ALL]);
            // When we call filterAndOrderOptions with a search value
            const filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(options, searchTerm, COUNTRY_CODE);
    ...
    describe('canCreateOptimisticPersonalDetailOption()', () => {
        ...
        it('should allow to create optimistic personal detail option if email is valid', () => {
            const canCreate = (0, OptionsListUtils_1.canCreateOptimisticPersonalDetailOption)({
        ...
        it('createOptionList() localization', () => {
            ...
            const reports = (0, OptionsListUtils_1.createOptionList)(PERSONAL_DETAILS, REPORTS).reports;
            ...
            return ((0, waitForBatchedUpdates_1.default)()
                ...
                .then(() => react_native_onyx_1.default.set(ONYXKEYS_1.default.NVP_PREFERRED_LOCALE, CONST_1.default.LOCALES.ES))
                .then(() => {
                // When we call createOptionList again
                const newReports = (0, OptionsListUtils_1.createOptionList)(PERSONAL_DETAILS, REPORTS).reports;
    ...
    describe('filterWorkspaceChats()', () => {
        it('should return an empty array if there are no expense chats', () => {
            ...
            const result = (0, OptionsListUtils_1.filterWorkspaceChats)([], []);
        ...
        it('should return all expense chats if there are no search terms', () => {
            ...
            // When we call filterWorkspaceChats
            const result = (0, OptionsListUtils_1.filterWorkspaceChats)(WORKSPACE_CHATS, []);
        ...
        it('should filter multiple expense chats by search term', () => {
            ...
            // When we call filterWorkspaceChats
            const result = (0, OptionsListUtils_1.filterWorkspaceChats)(WORKSPACE_CHATS, ['Google']);
        ...
        it('should filter expense chat by exact name', () => {
            ...
            // When we call filterWorkspaceChats
            const result = (0, OptionsListUtils_1.filterWorkspaceChats)(WORKSPACE_CHATS, ['Microsoft', 'Teams', 'Workspace']);
        ...
        it('should return an empty array if there are no matching expense chats', () => {
            ...
            // When we call filterWorkspaceChats
            const result = (0, OptionsListUtils_1.filterWorkspaceChats)(WORKSPACE_CHATS, ['XYZ']);
            // Then the returned value should be an empty array
            expect(result.length).toEqual(0);
        });
    });
    describe('orderWorkspaceOptions()', () => {
        it('should put the default workspace on top of the list', () => {
            ...
            const result = (0, OptionsListUtils_1.orderWorkspaceOptions)(WORKSPACE_CHATS);
    ...
    describe('Alternative text', () => {
        it("The text should not contain the last actor's name at prefix if the report is archived.", async () => {
            ...
            await react_native_onyx_1.default.multiSet({
                [ONYXKEYS_1.default.NVP_PREFERRED_LOCALE]: CONST_1.default.LOCALES.EN,
                [`${ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS}10`]: {
    ...
    describe('filterSelfDMChat()', () => {
        ...
        it('should return the report when there are no search terms', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)(REPORT, []);
            // Then the returned value should be the same as the input
        ...
        it('should return undefined, when the search term does not match the report', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)(REPORT, ['XYZ']);
        ...
        it('should filter report by text', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)(REPORT, ['Google']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should filter report by exact text', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)(REPORT, ['Google', 'Workspace']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should filter report by login', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, login: LOGIN }, ['john']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should filter report by exact login', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, login: LOGIN }, [LOGIN]);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should filter report by alternate text', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, alternateText: ALTERNATE_TEXT, isThread: true }, ['William']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should filter report by exact alternate text', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, alternateText: ALTERNATE_TEXT, isThread: true }, ['John', 'William', 'Doe']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should filter report by alternate text if it is not a thread', () => {
            ...
            // When we call filterSelfDMChat with the report and a search term that matches the report's alternate text
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, alternateText: ALTERNATE_TEXT, isThread: false }, ['William']);
            // Then the returned value should be undefined
        ...
        it('should filter report by subtitle', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, subtitle: SUBTITLE }, ['Software']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should filter report by exact subtitle', () => {
            ...
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, subtitle: SUBTITLE }, ['Software', 'Engineer']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
        it('should not filter report by subtitle if it is not an expense chat nor a chat room', () => {
            ...
            // When we call filterSelfDMChat with the report and a search term that matches the report's subtitle
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, subtitle: SUBTITLE, isPolicyExpenseChat: false, isChatRoom: false }, ['Software']);
            // Then the returned value should be undefined
            expect(result).toBeUndefined();
        });
        it('should filter report by subtitle if it is a chat room', () => {
            ...
            // When we call filterSelfDMChat with the report and a search term that matches the report's subtitle
            const result = (0, OptionsListUtils_1.filterSelfDMChat)({ ...REPORT, subtitle: SUBTITLE, isPolicyExpenseChat: false, isChatRoom: true }, ['Software']);
            // Then the returned value should be the same as the input
            expect(result?.reportID).toEqual(REPORT.reportID);
        });
    });
    describe('filterReports()', () => {
        it('should match a user with an accented name when searching using non-accented characters', () => {
            ...
            // cspell:disable-next-line
            const reports = [{ text: "Álex Timón D'artagnan Zo-e" }];
            ...
            const filteredReports = (0, OptionsListUtils_1.filterReports)(reports, searchTerms);
    ...
    describe('getMostRecentOptions()', () => {
        it('returns the most recent options up to the specified limit', () => {
            ...
            const comparator = (option) => option.lastVisibleActionCreated ?? '';
            const result = (0, OptionsListUtils_1.optionsOrderBy)(options, comparator, 2);
        ...
        it('returns all options if limit is greater than options length', () => {
            ...
            const comparator = (option) => option.lastVisibleActionCreated ?? '';
            const result = (0, OptionsListUtils_1.optionsOrderBy)(options, comparator, 5);
            expect(result.length).toBe(2);
            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        ...
        it('returns empty array if options is empty', () => {
            const result = (0, OptionsListUtils_1.optionsOrderBy)([], OptionsListUtils_1.recentReportComparator, 3);
        ...
        it('applies filter function if provided', () => {
            ...
            const comparator = (option) => option.lastVisibleActionCreated ?? '';
            const result = (0, OptionsListUtils_1.optionsOrderBy)(options, comparator, 2, (option) => option.isPinned);
            expect(result.length).toBe(2);
            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    ...
    describe('sortAlphabetically', () => {
        it('should sort options alphabetically by text', () => {
            const options = [{ text: 'Banana', reportID: '1' }, { text: 'Apple', reportID: '2' }, { text: 'Cherry', reportID: '3' }];
            const sortedOptions = (0, OptionsListUtils_1.sortAlphabetically)(options, 'text', TestHelper_1.localeCompare);
        ...
        it('should handle empty array', () => {
            const sortedOptions = (0, OptionsListUtils_1.sortAlphabetically)([], 'abc', TestHelper_1.localeCompare);
            expect(sortedOptions).toEqual([]);
        });
        it('should handle single option', () => {
            const options = [{ text: 'Single', reportID: '1' }];
            const sortedOptions = (0, OptionsListUtils_1.sortAlphabetically)(options, 'text', TestHelper_1.localeCompare);
    ...
    describe('getSearchValueForPhoneOrEmail', () => {
        it('should return E164 format for valid phone number', () => {
            const result = (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)('+1 (234) 567-8901', 1);
            expect(result).toBe('+12345678901');
        });
        it('should return E164 format for valid international phone number', () => {
            const result = (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)('+44 20 8759 9036', 44);
            expect(result).toBe('+442087599036');
        });
        it('should return lowercase for email address', () => {
            const result = (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)('Test@Example.COM', 1);
            expect(result).toBe('test@example.com');
        });
        it('should handle SMS domain removal for valid phone number', () => {
            const result = (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)('+12345678901@expensify.sms', 1);
            expect(result).toBe('+12345678901');
        });
        it('should return empty string for empty input', () => {
            const result = (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)('', 1);
            expect(result).toBe('');
        });
    });
});
