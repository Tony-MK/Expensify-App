...
const generateTranslations_1 = require("@scripts/generateTranslations");
const Translator_1 = require("@scripts/utils/Translator/Translator");
let processExitSpy;
let consoleErrorSpy;
// eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-assignment
let mockEn = jest.requireActual('@src/languages/en');
...
describe('generateTranslations', () => {
    ...
    it('translates nested structures', async () => {
        fs_1.default.writeFileSync(EN_PATH, (0, dedent_1.default)(`
            ...
            `), 'utf8');
        await (0, generateTranslations_1.default)();
        const itContent = fs_1.default.readFileSync(IT_PATH, 'utf8');
        expect(itContent).toStrictEqual(`${generateTranslations_1.GENERATED_FILE_PREFIX}${(0, dedent_1.default)(`
    ...
    it("doesn't request duplicate translations", async () => {
        fs_1.default.writeFileSync(EN_PATH, (0, dedent_1.default)(`
                ...
                export default strings;
            `), 'utf8');
        const translateSpy = jest.spyOn(Translator_1.default.prototype, 'translate');
        await (0, generateTranslations_1.default)();
        const itContent = fs_1.default.readFileSync(IT_PATH, 'utf8');
        expect(itContent).toStrictEqual(`${generateTranslations_1.GENERATED_FILE_PREFIX}${(0, dedent_1.default)(`
                import type en from './en';
    ...
    it('reuses existing translations from --compare-ref', async () => {
        ...
        const oldDir = fs_1.default.mkdtempSync(path_1.default.join(os_1.default.tmpdir(), 'translations-old-'));
        const oldItPath = path_1.default.join(oldDir, 'src/languages/it.ts');
        const oldEnPath = path_1.default.join(oldDir, 'src/languages/en.ts');
        ...
        jest.spyOn(GithubUtils_1.default, 'getFileContents').mockImplementation((filePath) => {
    ...
    it('ignores --compare-ref when --paths is provided', async () => {
        ...
        const translateSpy = jest.spyOn(Translator_1.default.prototype, 'translate');
        const githubSpy = jest.spyOn(GithubUtils_1.default, 'getFileContents');
        await (0, generateTranslations_1.default)();
        const itContent = fs_1.default.readFileSync(IT_PATH, 'utf8');
