...
describe('getSecondaryExportReportActions', function () {
    ...
    it('should always return default options', function () {
        var report = {};
        var policy = {};
        var result = [CONST_1.default.REPORT.EXPORT_OPTIONS.DOWNLOAD_CSV, CONST_1.default.REPORT.EXPORT_OPTIONS.EXPENSE_LEVEL_EXPORT, CONST_1.default.REPORT.EXPORT_OPTIONS.REPORT_LEVEL_EXPORT];
    ...
    it('includes REMOVE HOLD option for admin if he is not the holder', function () {
        ...
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: reportTransactions, violations: {}, policy: policy });
...
describe('getSecondaryTransactionThreadActions', function () {
    ...
    it('includes REMOVE HOLD option for transaction thread report admin if he is not the holder', function () {
        ...
        jest.spyOn(ReportUtils, 'isHoldCreator').mockReturnValue(false);
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(report, transaction, [], policy, transactionThreadReport);
        expect(result).toContain(CONST_1.default.REPORT.SECONDARY_ACTIONS.REMOVE_HOLD);
        // Do not show if admin is the holder
        jest.spyOn(ReportUtils, 'isHoldCreator').mockReturnValue(true);
        var result2 = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(report, transaction, [], policy, transactionThreadReport);
    ...
    it('should not include CHANGE_WORKSPACE option for exported report', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    _d.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [], violations: {}, policy: policy, policies: policies, reportActions: reportActions });
    ...
    it('includes the SPLIT option if the current user belongs to the workspace', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(report, transaction, [actions_1.actionR14932], policy);
