...
describe('ReportUtils', function () {
    ...
    describe('getChatRoomSubtitle', function () {
        ...
        it('should return policy name for user created policy room', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ROOM, policyID: policy.id });
            var result = (0, ReportUtils_1.getChatRoomSubtitle)(report);
            expect(result).toBe(policy.name);
        });
    ...
    describe('canHoldUnholdReportAction', function () {
        it('should return canUnholdRequest as true for a held duplicate transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
            var chatReport, reportPreviewReportActionID, expenseReport, expenseTransaction, reportPreview, expenseCreatedAction, transactionThreadReport, result;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 7:
                        ...
                        result = (0, react_native_1.renderHook)(function () { return (0, useAncestorReportsAndReportActions_1.default)(expenseReport.reportID, true); }).result;
        ...
        it('it should return false for archived invoice', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        canEditRequest = (0, ReportUtils_1.canEditMoneyRequest)(moneyRequestAction, transaction, true);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        activeReport = __assign(__assign({}, (0, reports_2.createRandomReport)(2)), { policyID: policy.id, type: CONST_1.default.REPORT.TYPE.EXPENSE, stateNum: CONST_1.default.REPORT.STATE_NUM.SUBMITTED, statusNum: CONST_1.default.REPORT.STATUS_NUM.SUBMITTED });
    ...
    describe('canAddTransaction', function () {
        it('should return true for a non-archived report', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(10000)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, ownerAccountID: currentUserAccountID });
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report.reportID), report)];
                    case 1:
                        _a.sent();
                        isReportArchived = (0, react_native_1.renderHook)(function () { return (0, useReportIsArchived_1.default)(report === null || report === void 0 ? void 0 : report.reportID); }).result;
        ...
        it('should return false for an expense report the current user is not the submitter', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(10000)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, ownerAccountID: currentUserAccountID + 1 });
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report.reportID), report)];
                    case 1:
                        _a.sent();
        ...
        it('should return false for an archived report', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(10001)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, ownerAccountID: currentUserAccountID });
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report.reportID), report)];
                    case 1:
                        _a.sent();
    ...
    describe('isDeprecatedGroupDM', function () {
        it('should return false if the report is a chat thread', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(0)), { parentReportActionID: '1', parentReportID: '1', type: CONST_1.default.REPORT.TYPE.CHAT, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1, 2]) });
        ...
        it('should return false if the report is a task report', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(0)), { type: CONST_1.default.REPORT.TYPE.TASK, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1, 2]) });
            expect((0, ReportUtils_1.isDeprecatedGroupDM)(report)).toBeFalsy();
        });
        it('should return false if the report is a money request report', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(0)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1, 2]) });
            expect((0, ReportUtils_1.isDeprecatedGroupDM)(report)).toBeFalsy();
        });
        it('should return false if the report is an archived room', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(0)), { participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1, 2]) });
        ...
        it('should return false if the report is a public / admin / announce chat room', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(0)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1, 2]) });
            expect((0, ReportUtils_1.isDeprecatedGroupDM)(report)).toBeFalsy();
        });
        it('should return false if the report has less than 2 participants', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(0)), { chatType: undefined, type: CONST_1.default.REPORT.TYPE.CHAT, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1]) });
            expect((0, ReportUtils_1.isDeprecatedGroupDM)(report)).toBeFalsy();
        });
        it('should return true if the report has more than 2 participants', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(0)), { chatType: undefined, type: CONST_1.default.REPORT.TYPE.CHAT, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1, 2]) });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        policyAnnounceRoom = __assign(__assign({}, (0, reports_2.createRandomReport)(50001)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ANNOUNCE, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1]), policyID: policy.id, writeCapability: CONST_1.default.REPORT.WRITE_CAPABILITIES.ADMINS });
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(workspace.id), workspace)];
                    case 1:
                        _a.sent();
                        result = (0, ReportUtils_1.canUserPerformWriteAction)(policyAnnounceRoom);
    ...
    describe('canLeaveChat', function () {
        ...
        it('should return true for policy expense chat if the user is not the owner and the user is not an admin', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_EXPENSE_CHAT, isOwnPolicyExpenseChat: false, policyID: '1' });
        ...
        it('should return false if the chat is public room and the user is the guest', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ROOM, visibility: CONST_1.default.REPORT.VISIBILITY.PUBLIC });
        ...
        it('should return false if the report is hidden for the current user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, participants: __assign(__assign({}, (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1234])), (_a = {}, _a[currentUserAccountID] = {
                                notificationPreference: CONST_1.default.REPORT.NOTIFICATION_PREFERENCE.HIDDEN,
                            }, _a)), chatType: undefined });
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.SESSION, { email: currentUserEmail, accountID: currentUserAccountID })];
                    case 1:
                        _b.sent();
                        expect((0, ReportUtils_1.canLeaveChat)(report, undefined)).toBe(false);
        ...
        it('should return false for selfDM reports', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: CONST_1.default.REPORT.CHAT_TYPE.SELF_DM });
            expect((0, ReportUtils_1.canLeaveChat)(report, undefined)).toBe(false);
        });
        it('should return false for the public announce room if the user is a member of the policy', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ROOM, visibility: CONST_1.default.REPORT.VISIBILITY.PUBLIC_ANNOUNCE });
            var reportPolicy = __assign(__assign({}, (0, policies_1.default)(1)), { role: CONST_1.default.POLICY.ROLE.USER });
        ...
        it('should return true for the invoice room if the user is not the sender or receiver', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.INVOICE, invoiceReceiver: {
        ...
        it('should return true for chat thread if the user is joined', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: undefined, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1234]), parentReportID: '12345', parentReportActionID: '67890' });
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.SESSION, { email: currentUserEmail, accountID: currentUserAccountID })];
                    case 1:
                        _a.sent();
                        expect((0, ReportUtils_1.canLeaveChat)(report, undefined)).toBe(true);
        ...
        it('should return true for user created policy room', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ROOM, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1234]) });
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.SESSION, { email: currentUserEmail, accountID: currentUserAccountID })];
                    case 1:
                        _a.sent();
                        reportPolicy = __assign(__assign({}, (0, policies_1.default)(1)), { role: CONST_1.default.POLICY.ROLE.USER });
    ...
    describe('canJoinChat', function () {
        ...
        it('should return false if the parent report action is a whisper action', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: CONST_1.default.REPORT.CHAT_TYPE.GROUP, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1234]) });
        ...
        it('should return false if the report is not hidden for the current user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: CONST_1.default.REPORT.CHAT_TYPE.GROUP, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1234]) });
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.SESSION, { email: currentUserEmail, accountID: currentUserAccountID })];
                    case 1:
                        _a.sent();
        ...
        it('should return false if the report is one of these types: group chat, selfDM, invoice room, system chat, expense chat', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: CONST_1.default.REPORT.CHAT_TYPE.GROUP });
            expect((0, ReportUtils_1.canJoinChat)(report, undefined, undefined)).toBe(false);
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, participants: __assign(__assign({}, (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1234])), (_a = {}, _a[currentUserAccountID] = {
                                notificationPreference: CONST_1.default.REPORT.NOTIFICATION_PREFERENCE.HIDDEN,
                            }, _a)), chatType: undefined, parentReportID: '12345', parentReportActionID: '67890' });
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.SESSION, { email: currentUserEmail, accountID: currentUserAccountID })];
                    case 1:
                        _b.sent();
    ...
    describe('isRootGroupChat', function () {
        it('should return false if the report is chat thread', function () {
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: undefined, parentReportID: '12345', parentReportActionID: '67890' });
    ...
    describe('isMoneyRequestReportEligibleForMerge', function () {
        ...
        it('should return false when report is not a money request report', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        chatReport = __assign(__assign({}, (0, reports_2.createRandomReport)(1)), { reportID: mockReportID, type: CONST_1.default.REPORT.TYPE.CHAT, chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ROOM });
    ...
    describe('buildOptimisticReportPreview', function () {
        it('should include childOwnerAccountID and childManagerAccountID that matches with iouReport data', function () {
            var chatReport = __assign(__assign({}, (0, reports_2.createRandomReport)(100)), { type: CONST_1.default.REPORT.TYPE.CHAT, chatType: undefined });
            var iouReport = __assign(__assign({}, (0, reports_2.createRandomReport)(200)), { parentReportID: '1', type: CONST_1.default.REPORT.TYPE.IOU, chatType: undefined, ownerAccountID: 1, managerID: 2 });
    ...
    describe('canSeeDefaultRoom', function () {
        it('should return true if report is archived room ', function () {
            var betas = [CONST_1.default.BETAS.DEFAULT_ROOMS];
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(40002)), { type: CONST_1.default.REPORT.TYPE.CHAT, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 1]) });
        ...
        it('should return true if the room has an assigned guide', function () {
            var betas = [CONST_1.default.BETAS.DEFAULT_ROOMS];
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(40002)), { participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID, 8]) });
            react_native_onyx_1.default.set(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, personalDetails).then(function () {
        ...
        it('should return true if the report is admin room', function () {
            var betas = [CONST_1.default.BETAS.DEFAULT_ROOMS];
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(40002)), { chatType: CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS });
            react_native_onyx_1.default.set(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, personalDetails).then(function () {
                expect((0, ReportUtils_1.canSeeDefaultRoom)(report, betas, false)).toBe(true);
            });
        });
    ...
    describe('getAllReportActionsErrorsAndReportActionThatRequiresAttention', function () {
        var report = __assign(__assign({}, (0, reports_2.createRandomReport)(40003)), { parentReportID: '40004', parentReportActionID: '2' });
        var parentReport = __assign(__assign({}, (0, reports_2.createRandomReport)(40004)), { statusNum: 0 });
        var reportAction1 = __assign(__assign({}, (0, reportActions_1.default)(1)), { reportID: report.reportID });
        var parentReportAction1 = __assign(__assign({}, (0, reportActions_1.default)(2)), { reportID: '40004', actorAccountID: currentUserAccountID });
        ...
        it("should return smart scan error with no report action when there's actions required and report is not archived", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        _e.sent();
                        _a = (0, ReportUtils_1.getAllReportActionsErrorsAndReportActionThatRequiresAttention)(report, reportActions, false), errors = _a.errors, reportAction = _a.reportAction;
