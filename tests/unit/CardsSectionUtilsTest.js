...
describe('CardSectionUtils', function () {
    ...
    it('should return undefined by default', function () {
        expect(utils_1.default.getBillingStatus({ translate: translateMock, stripeCustomerId: stripeCustomerId, accountData: ACCOUNT_DATA })).toBeUndefined();
    });
    it('should return POLICY_OWNER_WITH_AMOUNT_OWED variant', function () {
        ...
        expect(utils_1.default.getBillingStatus({ translate: translateMock, stripeCustomerId: stripeCustomerId, accountData: ACCOUNT_DATA })).toEqual({
    ...
    it('should return POLICY_OWNER_WITH_AMOUNT_OWED_OVERDUE variant with isRetryAvailable true when accountData is provided', function () {
        ...
        expect(utils_1.default.getBillingStatus({ translate: translateMock, stripeCustomerId: stripeCustomerId, accountData: ACCOUNT_DATA, purchase: mockPurchase })).toEqual({
    ...
    it('should return POLICY_OWNER_WITH_AMOUNT_OWED_OVERDUE variant with isRetryAvailable undefined when accountData is null', function () {
        ...
        expect(utils_1.default.getBillingStatus({ translate: translateMock, stripeCustomerId: stripeCustomerId, accountData: undefined })).toEqual({
            title: 'subscription.billingBanner.policyOwnerAmountOwedOverdue.title',
            subtitle: 'subscription.billingBanner.policyOwnerAmountOwedOverdue.subtitle',
            isError: true,
    ...
    it('should return CARD_EXPIRED variant with correct isRetryAvailableStatus for expired and unexpired card', function () {
        ...
        expect(utils_1.default.getBillingStatus({ translate: translateMock, stripeCustomerId: stripeCustomerId, accountData: __assign(__assign({}, ACCOUNT_DATA), { cardYear: 2023 }) })).toEqual({
