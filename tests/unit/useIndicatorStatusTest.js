...
const getMockForStatus = (status, isAdmin = true) => ({
    ...
    [`${ONYXKEYS_1.default.COLLECTION.POLICY}2`]: {
        id: '2',
        name: 'Workspace 2',
        owner: 'johndoe12@expensify.com',
        role: isAdmin ? 'admin' : 'user',
    ...
    [`${ONYXKEYS_1.default.COLLECTION.POLICY}3`]: {
        id: '3',
        name: 'Workspace 3',
        owner: 'johndoe12@expensify.com',
        role: isAdmin ? 'admin' : 'user',
    ...
    [`${ONYXKEYS_1.default.COLLECTION.POLICY}4`]: {
        id: '4',
        name: 'Workspace 4',
        owner: 'johndoe12@expensify.com',
    ...
    [ONYXKEYS_1.default.SUBSCRIPTION_RETRY_BILLING_STATUS_SUCCESSFUL]: status === CONST_1.default.INDICATOR_STATUS.HAS_SUBSCRIPTION_INFO,
    [ONYXKEYS_1.default.SUBSCRIPTION_RETRY_BILLING_STATUS_FAILED]: status === CONST_1.default.INDICATOR_STATUS.HAS_SUBSCRIPTION_ERRORS,
});
const TEST_CASES = [
    {
...
describe('useIndicatorStatusTest', () => {
    ...
    describe.each(TEST_CASES)('$name', (testCase) => {
        ...
        it('returns correct indicatorColor', () => {
            const { result } = (0, react_native_1.renderHook)(() => (0, useIndicatorStatus_1.default)());
