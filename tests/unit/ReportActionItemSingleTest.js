    ...
    describe('when the Report is a DM chat', function () {
        describe('component properly renders both avatar & name of the sender', function () {
            ...
            var fakePersonalDetails = (_a = {},
                ...
                _a);
            function setup() {
                var policyCollectionDataSet = (0, CollectionDataSet_1.toCollectionDataSet)(ONYXKEYS_1.default.COLLECTION.POLICY, [fakePolicy], function (item) { return item.id; });
                return (0, waitForBatchedUpdates_1.default)()
                    .then(function () {
                    var _a, _b, _c, _d;
                    return react_native_onyx_1.default.multiSet(__assign((_a = {}, _a[ONYXKEYS_1.default.PERSONAL_DETAILS_LIST] = fakePersonalDetails, _a[ONYXKEYS_1.default.IS_LOADING_REPORT_DATA] = false, _a[ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS] = (_b = {},
