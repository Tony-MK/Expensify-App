...
describe('IOU Utils', function () {
    ...
    describe('navigateToQuickAction', function () {
        ...
        it('should be navigated to Manual Submit Expense', function () {
            ...
            (0, QuickActionNavigation_1.navigateToQuickAction)(true, { action: CONST_1.default.QUICK_ACTIONS.REQUEST_MANUAL, chatReportID: reportID }, function (onSelected) {
                onSelected();
            });
        ...
        it('should be navigated to Scan receipt Split Expense', function () {
            ...
            (0, QuickActionNavigation_1.navigateToQuickAction)(true, { action: CONST_1.default.QUICK_ACTIONS.SPLIT_SCAN, chatReportID: reportID }, function (onSelected) {
                onSelected();
            });
        ...
        it('should be navigated to Track distance Expense', function () {
            ...
            (0, QuickActionNavigation_1.navigateToQuickAction)(true, { action: CONST_1.default.QUICK_ACTIONS.TRACK_DISTANCE, chatReportID: reportID }, function (onSelected) {
                onSelected();
            });
        ...
        it('should be navigated to Per Diem Expense', function () {
            ...
            (0, QuickActionNavigation_1.navigateToQuickAction)(true, { action: CONST_1.default.QUICK_ACTIONS.PER_DIEM, chatReportID: reportID }, function (onSelected) {
                onSelected();
            });
...
describe('Non IOU quickActions test:', function () {
    describe('navigateToQuickAction', function () {
        it('starts create task flow for "assignTask" quick action', function () {
            (0, QuickActionNavigation_1.navigateToQuickAction)(true, { action: CONST_1.default.QUICK_ACTIONS.ASSIGN_TASK, targetAccountID: 123 }, function (onSelected) {
                onSelected();
            });
