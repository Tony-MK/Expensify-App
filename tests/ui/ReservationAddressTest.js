...
const HotelTripDetails_1 = require("@pages/Travel/HotelTripDetails");
...
describe('ReservationAddressTest', () => {
    it('ReservationView should render the reservation address without double quotes', () => {
        ...
        const expectedAddress = `${(0, TripReservationUtils_1.getTripReservationCode)(mockReservationData.reservation)}${StringUtils_1.default.removeDoubleQuotes(mockReservationData.reservation.start.address)}`;
