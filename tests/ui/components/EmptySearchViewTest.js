                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(paidGroupPolicy.id), paidGroupPolicy)];
                        case 1:
                            _b.sent();
                            ...
                            (0, react_native_1.render)(<Wrapper>
                        <EmptySearchView_1.default similarSearchHash={(_a = queryJSON === null || queryJSON === void 0 ? void 0 : queryJSON.similarSearchHash) !== null && _a !== void 0 ? _a : 1} type={dataType} hasResults={false} groupBy={CONST_1.default.SEARCH.GROUP_BY.REPORTS}/>
                    </Wrapper>);
                            return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                        case 2:
                            _b.sent();
