...
const newComponentCategory_1 = require("../../.github/actions/javascript/authorChecklist/categories/newComponentCategory");
describe('detectReactComponent test', () => {
    it('should return undefined if no code is provided', () => {
        const result = (0, newComponentCategory_1.detectReactComponent)('', 'filename.js');
    ...
    it('should detect if code is React component', () => {
        ...
        `;
        const result = (0, newComponentCategory_1.detectReactComponent)(code, 'filename.js');
