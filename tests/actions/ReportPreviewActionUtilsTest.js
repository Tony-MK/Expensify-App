...
describe('getReportPreviewAction', function () {
    ...
    it('canPay should return true for submitted invoice', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    report = __assign(__assign({}, (0, reports_1.createRandomReport)(REPORT_ID)), { type: CONST_1.default.REPORT.TYPE.INVOICE, ownerAccountID: CURRENT_USER_ACCOUNT_ID, statusNum: CONST_1.default.REPORT.STATUS_NUM.SUBMITTED, stateNum: CONST_1.default.REPORT.STATE_NUM.SUBMITTED, isWaitingOnBankAccount: false, total: 7 });
                    policy = (0, policies_1.default)(0);
                    policy.role = CONST_1.default.POLICY.ROLE.ADMIN;
                    policy.type = CONST_1.default.POLICY.TYPE.CORPORATE;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    parentReport = __assign(__assign({}, (0, reports_1.createRandomReport)(Number(PARENT_REPORT_ID))), { type: CONST_1.default.REPORT.TYPE.INVOICE, invoiceReceiver: {
                            type: CONST_1.default.REPORT.INVOICE_RECEIVER_TYPE.INDIVIDUAL,
                            accountID: CURRENT_USER_ACCOUNT_ID,
                        }, policyID: '1' });
                    report = __assign(__assign({}, (0, reports_1.createRandomReport)(REPORT_ID)), { type: CONST_1.default.REPORT.TYPE.INVOICE, parentReportID: PARENT_REPORT_ID, ownerAccountID: CURRENT_USER_ACCOUNT_ID + 1, statusNum: CONST_1.default.REPORT.STATUS_NUM.SUBMITTED, stateNum: CONST_1.default.REPORT.STATE_NUM.SUBMITTED, isWaitingOnBankAccount: false, total: 0, policyID: '1' });
                    policy = (0, policies_1.default)(0);
                    policy.role = CONST_1.default.POLICY.ROLE.ADMIN;
                    policy.type = CONST_1.default.POLICY.TYPE.CORPORATE;
                    policy.reimbursementChoice = CONST_1.default.POLICY.REIMBURSEMENT_CHOICES.REIMBURSEMENT_NO;
