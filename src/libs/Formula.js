...
function computeReportPart(part, context) {
    ...
    switch (field.toLowerCase()) {
        ...
        case 'total':
            return formatAmount(report.total, (0, CurrencyUtils_1.getCurrencySymbol)(report.currency ?? '') ?? report.currency);
        case 'currency':
...
function formatType(type) {
    ...
    const typeMapping = {
        [CONST_1.default.REPORT.TYPE.EXPENSE]: 'Expense Report',
        [CONST_1.default.REPORT.TYPE.INVOICE]: 'Invoice',
        [CONST_1.default.REPORT.TYPE.CHAT]: 'Chat',
        [CONST_1.default.REPORT.UNSUPPORTED_TYPE.BILL]: 'Bill',
        [CONST_1.default.REPORT.UNSUPPORTED_TYPE.PAYCHECK]: 'Paycheck',
        [CONST_1.default.REPORT.TYPE.IOU]: 'IOU',
        [CONST_1.default.REPORT.TYPE.TASK]: 'Task',
        trip: 'Trip',
    };
...
function getOldestTransactionDate(reportID, context) {
    ...
    const transactions = (0, ReportUtils_1.getReportTransactions)(reportID);
    ...
    transactions.forEach((transaction) => {
        ...
        const created = (0, TransactionUtils_1.getCreated)(currentTransaction);
        if (!created) {
            return;
        }
