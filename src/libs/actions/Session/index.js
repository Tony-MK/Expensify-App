...
react_native_onyx_1.default.connect({
    ...
    callback: function (value) {
        ...
        if (!(session === null || session === void 0 ? void 0 : session.authToken) && isHybridAppSetupFinished) {
 ...
 */
function signOut() {
    return NetworkStore.hasReadShouldUseNewPartnerNameFromStorage().then(function () {
        var _a, _b;
        Log_1.default.info('Flushing logs before signing out', true, {}, true);
        var shouldUseNewPartnerName = NetworkStore.getShouldUseNewPartnerName();
        var params = {
