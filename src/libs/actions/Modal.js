 ...
 */
function close(onModalCloseCallback, isNavigating = true, shouldCloseAllModals = false) {
    if (closeModals.length === 0) {
 ...
 */
function setModalVisibility(isVisible, type = null) {
    react_native_onyx_1.default.merge(ONYXKEYS_1.default.MODAL, { isVisible, type });
}
/**
...
function setDisableDismissOnEscape(disableDismissOnEscape) {
    react_native_onyx_1.default.merge(ONYXKEYS_1.default.MODAL, { disableDismissOnEscape });
}
/**
 ...
 */
function willAlertModalBecomeVisible(isVisible, isPopover = false) {
    ...
    react_native_onyx_1.default.merge(ONYXKEYS_1.default.MODAL, { willAlertModalBecomeVisible: isVisible, isPopover });
}
