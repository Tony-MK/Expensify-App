...
const FS = {
    ...
    consent: (shouldConsent) => (0, browser_1.FullStory)(CONST_1.default.FULLSTORY.OPERATION.SET_IDENTITY, { consent: shouldConsent }),
        ...
        try {
            Environment.getEnvironment().then((envName) => {
                ...
                if ((CONST_1.default.ENVIRONMENT.PRODUCTION !== envName && !isTestEmail) ||
                    expensify_common_1.Str.extractEmailDomain(userMetadata.email ?? '') === CONST_1.default.EXPENSIFY_PARTNER_NAME ||
    ...
    anonymize: () => (0, browser_1.FullStory)(CONST_1.default.FULLSTORY.OPERATION.SET_IDENTITY, { anonymous: true }),
};
exports.default = FS;
