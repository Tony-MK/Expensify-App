...
function desktopLoginRedirect(autoAuthState, isSignedIn) {
    ...
    const shouldPopToTop = (autoAuthState === CONST_1.default.AUTO_AUTH_STATE.NOT_STARTED || autoAuthState === CONST_1.default.AUTO_AUTH_STATE.JUST_SIGNED_IN) && !isSignedIn;
    if (shouldPopToTop) {
        Navigation_1.default.isNavigationReady().then(() => Navigation_1.default.resetToHome());
    }
}
