...
function default_1() {
    ...
    return new Promise(function (resolve) {
        ...
        var migrationPromises = [RenameCardIsVirtual_1.default, RenameReceiptFilename_1.default, KeyReportActionsDraftByReportActionID_1.default, MoveIsOptimisticReportToMetadata_1.default, PendingMembersToMetadata_1.default];
