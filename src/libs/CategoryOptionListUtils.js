...
function getCategoryListSections(_a) {
    var categories = _a.categories, localeCompare = _a.localeCompare, searchValue = _a.searchValue, _b = _a.selectedOptions, selectedOptions = _b === void 0 ? [] : _b, _c = _a.recentlyUsedCategories, recentlyUsedCategories = _c === void 0 ? [] : _c, _d = _a.maxRecentReportsToShow, maxRecentReportsToShow = _d === void 0 ? CONST_1.default.IOU.MAX_RECENT_REPORTS_TO_SHOW : _d;
