 ...
 */
function getParentNavigationSubtitle(report: OnyxEntry<Report>, invoiceReceiverPolicy?: OnyxEntry<Policy>, isReportArchived = false): ParentNavigationSummaryParams {
    const parentReport = getParentReport(report);
