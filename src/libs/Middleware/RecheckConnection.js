...
function startRecheckTimeoutTimer() {
    ...
    const timerID = setTimeout(NetworkConnection_1.default.recheckNetworkConnection, CONST_1.default.NETWORK.MAX_PENDING_TIME_MS);
    return () => clearTimeout(timerID);
}
const RecheckConnection = (response) => {
