...
function requestContactPermission() {
    return (0, react_native_permissions_1.request)(react_native_permissions_1.PERMISSIONS.ANDROID.READ_CONTACTS);
}
function getContactPermission() {
    return (0, react_native_permissions_1.check)(react_native_permissions_1.PERMISSIONS.ANDROID.READ_CONTACTS);
}
