...
var userFriendlyStatusList = Object.values(__assign(__assign(__assign(__assign(__assign({}, CONST_1.default.SEARCH.STATUS.EXPENSE), CONST_1.default.SEARCH.STATUS.INVOICE), CONST_1.default.SEARCH.STATUS.CHAT), CONST_1.default.SEARCH.STATUS.TRIP), CONST_1.default.SEARCH.STATUS.TASK)).map(function (value) { return (0, SearchQueryUtils_1.getUserFriendlyValue)(value); });
/**
 * @private
 */
