...
function getForReportAction(_a) {
    ...
    var reportAction = _a.reportAction, policyID = _a.policyID, movedFromReport = _a.movedFromReport, movedToReport = _a.movedToReport;
    if (!(0, ReportActionsUtils_1.isModifiedExpenseAction)(reportAction)) {
        return '';
    }
    ...
    if (hasModifiedAmount) {
        ...
        var oldAmount = oldAmountValue > 0 ? (0, CurrencyUtils_1.convertToDisplayString)((_c = reportActionOriginalMessage === null || reportActionOriginalMessage === void 0 ? void 0 : reportActionOriginalMessage.oldAmount) !== null && _c !== void 0 ? _c : 0, oldCurrency) : '';
    ...
    if (hasModifiedTag) {
        var policyTags_1 = (_p = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["".concat(ONYXKEYS_1.default.COLLECTION.POLICY_TAGS).concat(policyID)]) !== null && _p !== void 0 ? _p : {};
