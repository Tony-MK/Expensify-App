...
const convertToNativeNavigationOptions_1 = require("@libs/Navigation/PlatformStackNavigation/navigationOptions/convertToNativeNavigationOptions");
function createPlatformStackNavigatorComponent(displayName, options) {
    ...
    function PlatformNavigator({ id, initialRouteName, screenOptions, screenListeners, children, sidebarScreen, defaultCentralScreen, parentRoute, ...props }) {
        const { navigation, state: originalState, descriptors, describe, NavigationContent, } = (0, native_1.useNavigationBuilder)(createRouter, {
            ...
            parentRoute,
        }, convertToNativeNavigationOptions_1.default);
