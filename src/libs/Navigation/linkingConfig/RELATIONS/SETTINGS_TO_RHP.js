...
const SETTINGS_TO_RHP = {
    ...
    [SCREENS_1.default.SETTINGS.ABOUT]: [SCREENS_1.default.SETTINGS.APP_DOWNLOAD_LINKS],
    [SCREENS_1.default.SETTINGS.SAVE_THE_WORLD]: [SCREENS_1.default.I_KNOW_A_TEACHER, SCREENS_1.default.INTRO_SCHOOL_PRINCIPAL, SCREENS_1.default.I_AM_A_TEACHER],
    [SCREENS_1.default.SETTINGS.TROUBLESHOOT]: [SCREENS_1.default.SETTINGS.CONSOLE, SCREENS_1.default.SETTINGS.EXIT_SURVEY.REASON, SCREENS_1.default.SETTINGS.EXIT_SURVEY.RESPONSE, SCREENS_1.default.SETTINGS.EXIT_SURVEY.CONFIRM],
