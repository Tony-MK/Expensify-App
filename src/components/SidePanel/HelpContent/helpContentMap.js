...
const HelpBulletList_1 = require("@components/SidePanel/HelpComponents/HelpBulletList");
const HelpNumberedList_1 = require("@components/SidePanel/HelpComponents/HelpNumberedList");
const Text_1 = require("@components/Text");
const TextLink_1 = require("@components/TextLink");
const helpContentMap = {
    children: {
        home: {
            content: ({ styles }) => (<react_native_1.View>
