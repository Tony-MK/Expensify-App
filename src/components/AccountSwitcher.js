...
function AccountSwitcher(_a) {
    ...
    var _h = (0, react_1.useState)(false), shouldShowDelegatorMenu = _h[0], setShouldShowDelegatorMenu = _h[1];
    var _j = (0, react_1.useState)(false), shouldShowOfflineModal = _j[0], setShouldShowOfflineModal = _j[1];
    ...
    var _k = (0, ProductTrainingContext_1.useProductTrainingContext)(CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.ACCOUNT_SWITCHER, isScreenFocused && canSwitchAccounts), shouldShowProductTrainingTooltip = _k.shouldShowProductTrainingTooltip, renderProductTrainingTooltip = _k.renderProductTrainingTooltip, hideProductTrainingTooltip = _k.hideProductTrainingTooltip;
