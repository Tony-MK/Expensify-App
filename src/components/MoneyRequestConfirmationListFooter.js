...
function MoneyRequestConfirmationListFooter(_a) {
    ...
    var shouldUseTransactionReport = !!transactionReport && (0, ReportUtils_1.isReportOutstanding)(transactionReport, policyID, undefined, false);
    ...
    var selectedReportID = shouldUseTransactionReport ? transactionReport.reportID : outstandingReportID;
    var selectedReport = (0, react_1.useMemo)(function () {
        if (!selectedReportID) {
            return;
        }
        return allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(selectedReportID)];
    }, [allReports, selectedReportID]);
    var reportName = (0, ReportUtils_1.getReportName)(selectedReport, selectedPolicy);
    if (!reportName) {
        var optimisticReport = (0, ReportUtils_1.buildOptimisticExpenseReport)(reportID, selectedPolicy === null || selectedPolicy === void 0 ? void 0 : selectedPolicy.id, (_h = selectedPolicy === null || selectedPolicy === void 0 ? void 0 : selectedPolicy.ownerAccountID) !== null && _h !== void 0 ? _h : CONST_1.default.DEFAULT_NUMBER_ID, Number(formattedAmount), currency);
        selectedReportID = !selectedReportID ? optimisticReport.reportID : selectedReportID;
        reportName = (0, ReportUtils_1.populateOptimisticReportFormula)((_l = (_k = (_j = selectedPolicy === null || selectedPolicy === void 0 ? void 0 : selectedPolicy.fieldList) === null || _j === void 0 ? void 0 : _j.text_title) === null || _k === void 0 ? void 0 : _k.defaultValue) !== null && _l !== void 0 ? _l : '', optimisticReport, selectedPolicy);
    }
    ...
    var taxRates = (_m = policy === null || policy === void 0 ? void 0 : policy.taxRates) !== null && _m !== void 0 ? _m : null;
    ...
    var shouldShowBillable = ((_o = policy === null || policy === void 0 ? void 0 : policy.disabledFields) === null || _o === void 0 ? void 0 : _o.defaultBillable) === false;
    var shouldShowReimbursable = isPolicyExpenseChat && ((_p = policy === null || policy === void 0 ? void 0 : policy.disabledFields) === null || _p === void 0 ? void 0 : _p.reimbursable) === false && !(0, TransactionUtils_1.isCardTransaction)(transaction) && !isTypeInvoice;
    ...
    var _u = receiptPath && receiptFilename ? (0, ReceiptUtils_1.getThumbnailAndImageURIs)(transaction, receiptPath, receiptFilename) : {}, receiptImage = _u.image, receiptThumbnail = _u.thumbnail, isThumbnail = _u.isThumbnail, fileExtension = _u.fileExtension, isLocalFile = _u.isLocalFile;
    ...
    var previousTagsVisibility = (_q = (0, usePrevious_1.default)(tagVisibility.map(function (v) { return v.shouldShow; }))) !== null && _q !== void 0 ? _q : [];
    ...
    var _v = (0, PerDiemRequestUtils_1.getTimeDifferenceIntervals)(transaction), firstDay = _v.firstDay, tripDays = _v.tripDays, lastDay = _v.lastDay;
