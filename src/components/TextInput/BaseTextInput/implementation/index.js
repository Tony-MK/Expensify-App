...
value = undefined, defaultValue = undefined, placeholder = '', errorText = '', icon = null, iconLeft = null, textInputContainerStyles, shouldApplyPaddingToContainer = true, touchableInputWrapperStyle, containerStyles, inputStyle, forceActiveLabel = false, disableKeyboard = false, autoGrow = false, autoGrowHeight = false, maxAutoGrowHeight, hideFocusedState = false, maxLength = undefined, hint = '', onInputChange = () => { }, multiline = false, shouldInterceptSwipe = false, autoCorrect = true, prefixCharacter = '', suffixCharacter = '', inputID, type = 'default', excludedMarkdownStyles = [], shouldShowClearButton = false, shouldHideClearButton = true, shouldUseDisabledStyles = true, prefixContainerStyle = [], prefixStyle = [], suffixContainerStyle = [], suffixStyle = [], contentWidth, loadingSpinnerStyle, uncontrolled = false, placeholderTextColor, onClearInput, iconContainerStyle, shouldUseDefaultLineHeightForPrefix = true, ref, ...inputProps }) {
    ...
    const labelScale = (0, react_native_reanimated_1.useSharedValue)(initialActiveLabel ? styleConst_1.ACTIVE_LABEL_SCALE : styleConst_1.INACTIVE_LABEL_SCALE);
    const labelTranslateY = (0, react_native_reanimated_1.useSharedValue)(initialActiveLabel ? styleConst_1.ACTIVE_LABEL_TRANSLATE_Y : styleConst_1.INACTIVE_LABEL_TRANSLATE_Y);
    const input = (0, react_1.useRef)(null);
    const isLabelActive = (0, react_1.useRef)(initialActiveLabel);
    const didScrollToEndRef = (0, react_1.useRef)(false);
    ...
    const inputMode = inputProps.inputMode ?? ((0, Browser_1.isMobileChrome)() ? 'search' : undefined);
    return (<>
...
to prevent text overlapping with label when scrolling */}
            ...
            }} tabIndex={-1} style={[styles.textInputPrefix, !hasLabel && styles.pv0, styles.pointerEventsNone, prefixStyle]} dataSet={{ [CONST_1.default.SELECTION_SCRAPER_HIDDEN_ELEMENT]: true }} shouldUseDefaultLineHeight={shouldUseDefaultLineHeightForPrefix}>
                                        {prefixCharacter}
                                    </Text_1.default>
                                </react_native_1.View>)}
    ...
    {...inputProps} autoCorrect={inputProps.secureTextEntry ? false : autoCorrect} placeholder={newPlaceholder} placeholderTextColor={placeholderTextColor ?? theme.placeholderText} underlineColorAndroid="transparent" style={[
            styles.flex1,
            styles.w100,
            inputStyle,
            ...
            !isMultiline && (0, Browser_1.isMobileChrome)() && { boxSizing: 'content-box', height: undefined, ...styles.overflowAuto },
            ...
            styles.pointerEventsAuto,
                            ...
                            {((isFocused && !isReadOnly && shouldShowClearButton) || !shouldHideClearButton) && !!value && !inputProps.isLoading && (<react_native_1.View onLayout={() => {
                ...
                didScrollToEndRef.current = true;
                                    ...
                                    <TextInputClearButton_1.default onPressButton={() => {
                setValue('');
                onClearInput?.();
                ...
                StyleUtils.getOpacityStyle(inputProps.isLoading ? 1 : 0),
                            ...
                            {!!inputProps.secureTextEntry && (<Checkbox_1.default style={StyleUtils.getTextInputIconContainerStyles(hasLabel, true, verticalPaddingDiff)} onPress={togglePasswordVisibility} onMouseDown={(e) => {
                e.preventDefault();
