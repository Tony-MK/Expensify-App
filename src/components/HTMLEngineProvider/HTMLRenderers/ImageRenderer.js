...
var ImageRendererMemorize = (0, react_1.memo)(ImageRenderer, function (prevProps, nextProps) { return prevProps.tnode.attributes === nextProps.tnode.attributes && prevProps.shouldUseStagingServer === nextProps.shouldUseStagingServer; });
function ImageRendererWrapper(props) {
    var shouldUseStagingServer = (0, useOnyx_1.default)(ONYXKEYS_1.default.SHOULD_USE_STAGING_SERVER, { canBeMissing: true })[0];
