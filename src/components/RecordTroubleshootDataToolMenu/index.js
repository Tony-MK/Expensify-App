...
function RecordTroubleshootDataToolMenu() {
    ...
    return (<BaseRecordTroubleshootDataToolMenu_1.default zipRef={zipRef} file={file} onDisableLogging={onDisableLogging} onEnableLogging={hideShareButton} pathToBeUsed="" onDownloadZip={onDownloadZip}/>);
}
