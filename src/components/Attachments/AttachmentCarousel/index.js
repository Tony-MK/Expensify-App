...
function AttachmentCarousel(_a) {
    var report = _a.report, attachmentID = _a.attachmentID, source = _a.source, onNavigate = _a.onNavigate, setDownloadButtonVisibility = _a.setDownloadButtonVisibility, type = _a.type, accountID = _a.accountID, onClose = _a.onClose, attachmentLink = _a.attachmentLink, onAttachmentError = _a.onAttachmentError, onAttachmentLoaded = _a.onAttachmentLoaded;
