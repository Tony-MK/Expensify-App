...
function AttachmentCarouselPager(_a, ref) {
    var items = _a.items, activeAttachmentID = _a.activeAttachmentID, initialPage = _a.initialPage, setShouldShowArrows = _a.setShouldShowArrows, onPageSelected = _a.onPageSelected, onClose = _a.onClose, reportID = _a.reportID, onAttachmentError = _a.onAttachmentError, onAttachmentLoaded = _a.onAttachmentLoaded;
