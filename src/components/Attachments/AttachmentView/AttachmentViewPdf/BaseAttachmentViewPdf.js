...
function BaseAttachmentViewPdf({ file, encryptedSourceUrl, isFocused, onPress: onPressProp, onScaleChanged: onScaleChangedProp, onToggleKeyboard, onLoadComplete, style, isUsedAsChatAttachment, onLoadError, }) {
     ...
     */
    const onScaleChanged = (0, react_1.useCallback)((newScale) => {
    ...
    return (<PDFView_1.default onPress={onPress} isFocused={isFocused} sourceURL={encryptedSourceUrl} fileName={file?.name} style={style} onToggleKeyboard={onToggleKeyboard} onScaleChanged={onScaleChanged} onLoadComplete={onLoadComplete} isUsedAsChatAttachment={isUsedAsChatAttachment} onLoadError={onLoadError}/>);
}
