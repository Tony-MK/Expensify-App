...
function KYCWall(_a) {
    ...
    var selectPaymentMethod = (0, react_1.useCallback)(function (paymentMethod, policy) {
        ...
        if (paymentMethod === CONST_1.default.PAYMENT_METHODS.PERSONAL_BANK_ACCOUNT) {
            ...
            if (iouReport && (0, ReportUtils_1.isIOUReport)(iouReport)) {
                if (policy) {
                    var policyExpenseChatReportID = (_a = (0, ReportUtils_1.getPolicyExpenseChat)(iouReport.ownerAccountID, policy.id, allReports)) === null || _a === void 0 ? void 0 : _a.reportID;
                    if (!policyExpenseChatReportID) {
                        var newPolicyExpenseChatReportID = ((_b = (0, Report_1.moveIOUReportToPolicyAndInviteSubmitter)(iouReport.reportID, policy.id, formatPhoneNumber)) !== null && _b !== void 0 ? _b : {}).policyExpenseChatReportID;
                        (0, IOU_1.savePreferredPaymentMethod)(iouReport.policyID, policy.id, CONST_1.default.LAST_PAYMENT_METHOD.IOU, lastPaymentMethod === null || lastPaymentMethod === void 0 ? void 0 : lastPaymentMethod[policy.id]);
                    ...
                    if (policy === null || policy === void 0 ? void 0 : policy.achAccount) {
                        return;
                    }
                ...
                var _d = (_c = (0, Policy_1.createWorkspaceFromIOUPayment)(iouReport)) !== null && _c !== void 0 ? _c : {}, policyID = _d.policyID, workspaceChatReportID = _d.workspaceChatReportID, reportPreviewReportActionID = _d.reportPreviewReportActionID, adminsChatReportID = _d.adminsChatReportID;
     ...
     *
     */
    var continueAction = (0, react_1.useCallback)(function (event, iouPaymentType, paymentMethod, policy) {
        var _a, _b, _c;
