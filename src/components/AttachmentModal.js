...
function AttachmentModal(_a) {
    ...
    var _7 = (0, react_1.useState)(false), isConfirmButtonDisabled = _7[0], setIsConfirmButtonDisabled = _7[1];
    var _8 = react_1.default.useState(true), isDownloadButtonReadyToBeShown = _8[0], setIsDownloadButtonReadyToBeShown = _8[1];
    ...
    var _9 = (0, react_1.useState)(attachmentLink), currentAttachmentLink = _9[0], setCurrentAttachmentLink = _9[1];
    var _10 = (0, useAttachmentErrors_1.default)(), setAttachmentError = _10.setAttachmentError, isErrorInAttachment = _10.isErrorInAttachment, clearAttachmentErrors = _10.clearAttachmentErrors;
    var _11 = (0, react_1.useState)(originalFileName
        ? {
            name: originalFileName,
        }
        : undefined), file = _11[0], setFile = _11[1];
    ...
    return (<>
            <Modal_1.default type={CONST_1.default.MODAL.MODAL_TYPE.CENTERED_UNSWIPEABLE} onClose={isOverlayModalVisible ? closeConfirmModal : closeModal} isVisible={isModalOpen} onModalShow={function () {
            onModalShow();
            ...
            {children === null || children === void 0 ? void 0 : children({ show: openModal })}
        </>);
}
