...
function ScreenWrapper(_a) {
    ...
    var _k = (0, useOnyx_1.default)(ONYXKEYS_1.default.HYBRID_APP, { selector: function (hybridApp) { return hybridApp === null || hybridApp === void 0 ? void 0 : hybridApp.isSingleNewDotEntry; }, canBeMissing: true })[0], isSingleNewDotEntry = _k === void 0 ? false : _k;
