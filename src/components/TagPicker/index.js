...
function TagPicker(_a) {
    ...
    var _l = (0, useLocalize_1.default)(), translate = _l.translate, localeCompare = _l.localeCompare;
    var _m = (0, react_1.useState)(''), searchValue = _m[0], setSearchValue = _m[1];
    ...
    var availableTagsCount = Array.isArray(enabledTags) ? enabledTags.length : Object.keys(enabledTags).length;
    var isTagsCountBelowThreshold = availableTagsCount < CONST_1.default.STANDARD_LIST_ITEM_LIMIT;
