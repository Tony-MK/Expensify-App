...
function CustomStatusBarAndBackground(_a) {
    ...
    var _e = (0, useOnyx_1.default)(ONYXKEYS_1.default.HYBRID_APP, { selector: function (hybridApp) { return hybridApp === null || hybridApp === void 0 ? void 0 : hybridApp.closingReactNativeApp; }, canBeMissing: true })[0], closingReactNativeApp = _e === void 0 ? false : _e;
