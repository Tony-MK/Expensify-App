...
function Lightbox(_a) {
    var _b = _a.isAuthTokenRequired, isAuthTokenRequired = _b === void 0 ? false : _b, uri = _a.uri, onScaleChangedProp = _a.onScaleChanged, onError = _a.onError, style = _a.style, _c = _a.zoomRange, zoomRange = _c === void 0 ? MultiGestureCanvas_1.DEFAULT_ZOOM_RANGE : _c, onLoad = _a.onLoad;
