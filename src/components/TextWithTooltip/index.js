...
function TextWithTooltip(_a) {
    var text = _a.text, shouldShowTooltip = _a.shouldShowTooltip, style = _a.style, _b = _a.numberOfLines, numberOfLines = _b === void 0 ? 1 : _b, forwardedFSClass = _a.forwardedFSClass;
