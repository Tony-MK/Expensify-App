...
function SearchAutocompleteInput(_a, forwardedRef) {
    ...
    var _h = wrapperFocusedStyle.borderColor, focusedBorderColor = _h === void 0 ? theme.border : _h, restWrapperFocusedStyle = __rest(wrapperFocusedStyle, ["borderColor"]);
    var _j = wrapperStyle !== null && wrapperStyle !== void 0 ? wrapperStyle : {}, _k = _j.borderColor, wrapperBorderColor = _k === void 0 ? theme.border : _k, restWrapperStyle = __rest(_j, ["borderColor"]);
