...
const transactionData = {
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_1`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_2`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_3`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_4`]: { transactionID: 'FAKE_4', amount: 444444, currency: 'USD', cardID: 4, merchant: 'Chevron', mccGroup: 'Gas', created: '2023-07-24 13:46:20' },
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_5`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_6`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_7`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_8`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_9`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_10`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_11`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_12`]: { transactionID: 'FAKE_12', amount: 1000, currency: 'USD', cardID: 4, merchant: 'Uber', mccGroup: 'Taxi', created: '2023-07-24 13:46:20' },
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_13`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_14`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_15`]: {
    ...
    [`${ONYXKEYS_1.default.COLLECTION.TRANSACTION}FAKE_16`]: {
