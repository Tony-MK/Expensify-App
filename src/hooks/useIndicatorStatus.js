...
function useIndicatorStatus() {
    ...
    var infoChecking = (_d = {},
        ...
        _d[CONST_1.default.INDICATOR_STATUS.HAS_SUBSCRIPTION_INFO] = (0, SubscriptionUtils_1.hasSubscriptionGreenDotInfo)(stripeCustomerId),
        _d);
