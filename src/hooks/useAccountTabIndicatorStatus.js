...
function useAccountTabIndicatorStatus() {
    ...
    var errorChecking = (_a = {},
        ...
        _a[CONST_1.default.INDICATOR_STATUS.HAS_SUBSCRIPTION_ERRORS] = (0, SubscriptionUtils_1.hasSubscriptionRedDotError)(stripeCustomerId),
        _a);
    var infoChecking = (_b = {},
        ...
        _b[CONST_1.default.INDICATOR_STATUS.HAS_SUBSCRIPTION_INFO] = (0, SubscriptionUtils_1.hasSubscriptionGreenDotInfo)(stripeCustomerId),
        _b);
