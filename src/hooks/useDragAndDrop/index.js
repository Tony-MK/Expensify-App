 ...
 */
const useDragAndDrop = ({ dropZone, onDrop = () => { }, shouldAllowDrop = true, isDisabled = false, shouldAcceptDrop = () => true, shouldHandleDragEvent = true, shouldStopPropagation = true, }) => {
    const isFocused = (0, native_1.useIsFocused)();
    const [isDraggingOver, setIsDraggingOver] = (0, react_1.useState)(false);
    const { close: closePopover } = (0, react_1.useContext)(PopoverProvider_1.PopoverContext);
    ...
    const handleDragEvent = (0, react_1.useCallback)((event) => {
     ...
     */
    const dropZoneDragHandler = (0, react_1.useCallback)((event) => {
