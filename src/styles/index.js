...
const clamp_1 = require("lodash/clamp");
// eslint-disable-next-line no-restricted-imports
const react_native_1 = require("react-native");
const react_native_reanimated_1 = require("react-native-reanimated");
const styleConst_1 = require("@components/TextInput/styleConst");
...
const addOutlineWidth_1 = require("./utils/addOutlineWidth");
const borders_1 = require("./utils/borders");
const chatContentScrollViewPlatformStyles_1 = require("./utils/chatContentScrollViewPlatformStyles");
const cursor_1 = require("./utils/cursor");
const display_1 = require("./utils/display");
const editedLabelStyles_1 = require("./utils/editedLabelStyles");
const emojiDefaultStyles_1 = require("./utils/emojiDefaultStyles");
const flex_1 = require("./utils/flex");
const FontUtils_1 = require("./utils/FontUtils");
const getPopOverVerticalOffset_1 = require("./utils/getPopOverVerticalOffset");
const objectFit_1 = require("./utils/objectFit");
const optionAlternateTextPlatformStyles_1 = require("./utils/optionAlternateTextPlatformStyles");
const overflow_1 = require("./utils/overflow");
const overflowXHidden_1 = require("./utils/overflowXHidden");
const pointerEventsAuto_1 = require("./utils/pointerEventsAuto");
const pointerEventsBoxNone_1 = require("./utils/pointerEventsBoxNone");
const pointerEventsNone_1 = require("./utils/pointerEventsNone");
const positioning_1 = require("./utils/positioning");
const sizing_1 = require("./utils/sizing");
const spacing_1 = require("./utils/spacing");
const textDecorationLine_1 = require("./utils/textDecorationLine");
const textUnderline_1 = require("./utils/textUnderline");
const translateZ0_1 = require("./utils/translateZ0");
const userSelect_1 = require("./utils/userSelect");
const visibility_1 = require("./utils/visibility");
const whiteSpace_1 = require("./utils/whiteSpace");
const wordBreak_1 = require("./utils/wordBreak");
const writingDirection_1 = require("./utils/writingDirection");
const variables_1 = require("./variables");
// touchCallout is an iOS safari only property that controls the display of the callout information when you touch and hold a target
const touchCalloutNone = (0, Browser_1.isMobileSafari)() ? { WebkitTouchCallout: 'none' } : {};
// to prevent vertical text offset in Safari for badges, new lineHeight values have been added
const lineHeightBadge = (0, Browser_1.isSafari)() ? { lineHeight: variables_1.default.lineHeightXSmall } : { lineHeight: variables_1.default.lineHeightNormal };
const picker = (theme) => ({
...
const headlineFont = {
    ...FontUtils_1.default.fontFamily.platform.EXP_NEW_KANSAS_MEDIUM,
};
const headlineItalicFont = {
    ...FontUtils_1.default.fontFamily.platform.EXP_NEW_KANSAS_MEDIUM_ITALIC,
};
const modalNavigatorContainer = (isSmallScreenWidth) => ({
    position: 'absolute',
...
const webViewStyles = (theme) => ({
    ...
    tagStyles: {
        ...
        video: {
            minWidth: CONST_1.default.VIDEO_PLAYER.MIN_WIDTH,
            minHeight: CONST_1.default.VIDEO_PLAYER.MIN_HEIGHT,
            borderRadius: variables_1.default.componentBorderRadiusNormal,
    ...
    baseFontStyle: {
        ...
        flex: 1,
        lineHeight: variables_1.default.fontSizeNormalHeight,
        ...writingDirection_1.default.ltr,
    },
});
const styles = (theme) => ({
    ...
    ...display_1.default,
    ...overflow_1.default,
    ...positioning_1.default,
    ...wordBreak_1.default,
    ...translateZ0_1.default,
    ...whiteSpace_1.default,
    ...writingDirection_1.default,
    ...cursor_1.default,
    ...userSelect_1.default,
    ...textUnderline_1.default,
    ...objectFit_1.default,
    ...textDecorationLine_1.default,
    editedLabelStyles: editedLabelStyles_1.default,
    emojiDefaultStyles: emojiDefaultStyles_1.default,
    ...
    emojiSuggestionsText: {
        fontSize: variables_1.default.fontSizeMedium,
        flex: 1,
        ...wordBreak_1.default.breakWord,
        ...spacing_1.default.pr4,
    },
    emojiTooltipWrapper: {
        ...spacing_1.default.p2,
        borderRadius: 8,
    },
    customEmojiFont: FontUtils_1.default.fontFamily.single.CUSTOM_EMOJI_FONT,
    ...
    mentionSuggestionsText: {
        fontSize: variables_1.default.fontSizeMedium,
        ...spacing_1.default.ml2,
    },
    mentionSuggestionsDisplayName: {
        ...FontUtils_1.default.fontFamily.platform.EXP_NEUE_BOLD,
    },
    textSupporting: {
    ...
    textExtraSmallSupporting: {
        ...
        ...FontUtils_1.default.fontFamily.platform.EXP_NEUE,
        fontSize: variables_1.default.fontSizeExtraSmall,
        lineHeight: variables_1.default.lineHeightXSmall,
    },
    textDoubleDecker: {
        fontSize: variables_1.default.fontSizeSmall,
        opacity: 0.8,
    ...
    textHero: {
        fontSize: variables_1.default.fontSizeHero,
        ...FontUtils_1.default.fontFamily.platform.EXP_NEW_KANSAS_MEDIUM,
        lineHeight: variables_1.default.lineHeightHero,
    },
    textStrong: {
        ...FontUtils_1.default.fontFamily.platform.EXP_NEUE_BOLD,
    },
    ...
    textHeadlineH2: {
        ...
        ...whiteSpace_1.default.preWrap,
        color: theme.heading,
        fontSize: variables_1.default.fontSizeH2,
        lineHeight: variables_1.default.lineHeightSizeH2,
    },
    textHeadlineH1: {
        ...headlineFont,
        ...whiteSpace_1.default.preWrap,
        color: theme.heading,
        fontSize: variables_1.default.fontSizeXLarge,
        lineHeight: variables_1.default.lineHeightSizeH1,
    },
    textWhite: {
    ...
    textItalic: {
        ...FontUtils_1.default.fontFamily.platform.MONOSPACE_ITALIC,
    },
    textVersion: {
    ...
    topLevelNavigationTabBar: (shouldDisplayTopLevelNavigationTabBar, shouldUseNarrowLayout, bottomSafeAreaOffset) => ({
    ...
    button: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        ...spacing_1.default.ph3,
        ...spacing_1.default.pv0,
    },
    buttonContainer: {
        borderRadius: variables_1.default.buttonBorderRadius,
    },
    ...
    testRowContainer: {
        ...flex_1.default.flexRow,
        ...flex_1.default.justifyContentBetween,
        ...flex_1.default.alignItemsCenter,
        ...sizing_1.default.mnw120,
        ...spacing_1.default.gap4,
        minHeight: 64,
    },
    buttonSmall: {
        borderRadius: variables_1.default.buttonBorderRadius,
    ...
    pickerSmall: (disabled = false, backgroundColor = theme.highlightBG) => ({
        ...
        inputWeb: {
            ...
            opacity: 1,
            backgroundColor,
            ...(disabled ? cursor_1.default.cursorDisabled : cursor_1.default.cursorPointer),
        },
        inputAndroid: {
            ...FontUtils_1.default.fontFamily.platform.EXP_NEUE,
            fontSize: variables_1.default.fontSizeSmall,
    ...
    uploadFileView: (isSmallScreenWidth) => ({
        borderRadius: variables_1.default.componentBorderRadiusLarge,
    ...
    calendarHeader: {
        ...
        justifyContent: 'space-between',
        alignItems: 'center',
        ...userSelect_1.default.userSelectNone,
    },
    calendarDayRoot: {
        flex: 1,
    ...
    textInputLabelTransformation: (translateY, scale, isForTextComponent) => {
        'worklet';
    ...
    textInputAndIconContainer: (isMarkdownEnabled) => {
    ...
    textInput: {
        backgroundColor: 'transparent',
        borderRadius: variables_1.default.componentBorderRadiusNormal,
        height: variables_1.default.inputComponentSizeNormal,
        borderColor: theme.border,
        borderWidth: 1,
        color: theme.text,
        ...FontUtils_1.default.fontFamily.platform.EXP_NEUE,
    ...
    picker: (disabled = false, backgroundColor = theme.appBG) => ({
        iconContainer: {
            top: Math.round(variables_1.default.inputHeight * 0.5) - 11,
            right: 0,
            ...pointerEventsNone_1.default,
        },
        inputWeb: {
    ...
    navigationTabBarStatusIndicator: (backgroundColor = theme.danger) => ({
        borderColor: theme.sidebar,
        backgroundColor,
        borderRadius: 8,
        borderWidth: 2,
    ...
    modalStackNavigatorContainer: (isSmallScreenWidth) => ({
        width: isSmallScreenWidth ? '100%' : variables_1.default.sideBarWidth,
        height: '100%',
        right: 0,
        position: react_native_1.Platform.OS === 'web' ? 'fixed' : 'absolute',
    }),
    animatedRHPNavigatorContainer: (shouldUseNarrowLayout, expandedRHPProgress) => ({
        height: '100%',
    ...
    OnboardingNavigatorInnerView: (shouldUseNarrowLayout) => ({
    ...
    createAccountMenuPositionProfile: () => ({
        horizontal: 18,
        ...(0, getPopOverVerticalOffset_1.default)(202 + 40),
    }),
    createMenuPositionReportActionCompose: (shouldUseNarrowLayout, windowHeight, windowWidth) => ({
    ...
    optionAlternateTextCompact: {
        ...
        flexGrow: 1,
        flexBasis: 'auto',
        ...optionAlternateTextPlatformStyles_1.default,
    },
    optionRow: {
    ...
    overlayStyles: ({ progress, hasMarginRight = false, hasMarginLeft = false }) => ({
        ...positioning_1.default.pFixed,
        // We need to stretch the overlay to cover the sidebar and the translate animation distance.
        left: hasMarginLeft ? variables_1.default.receiptPaneRHPMaxWidth : -2 * variables_1.default.sideBarWidth,
        top: 0,
        bottom: 0,
        right: hasMarginRight ? variables_1.default.sideBarWidth : 0,
    ...
    chatContentScrollView: {
        ...
        paddingBottom: 16,
        ...chatContentScrollViewPlatformStyles_1.default,
    },
    // Chat Item
    chatItem: {
        display: 'flex',
    ...
    textInputCompose: (0, addOutlineWidth_1.default)(theme, {
        backgroundColor: theme.componentBG,
        borderColor: theme.border,
        color: theme.text,
        ...FontUtils_1.default.fontFamily.platform.EXP_NEUE,
        ...
        height: 'auto',
        lineHeight: variables_1.default.lineHeightXLarge,
        ...overflowXHidden_1.default,
        // On Android, multiline TextInput with height: 'auto' will show extra padding unless they are configured with
        // paddingVertical: 0, alignSelf: 'center', and verticalAlign: 'middle'
        paddingHorizontal: variables_1.default.avatarChatSpacing,
        paddingTop: 0,
        paddingBottom: 0,
        alignSelf: 'center',
        verticalAlign: 'middle',
    ...
    emojiText: {
        textAlign: 'center',
        fontSize: variables_1.default.emojiSize,
        ...spacing_1.default.pv0,
        ...spacing_1.default.ph0,
        lineHeight: variables_1.default.emojiLineHeight,
    },
    emojiItem: {
        width: '100%',
        textAlign: 'center',
    ...
    chatItemPDFAttachmentLoading: {
        ...
        borderRadius: variables_1.default.componentBorderRadiusNormal,
        ...flex_1.default.alignItemsCenter,
        ...flex_1.default.justifyContentCenter,
    },
    exampleCheckImage: {
        width: '100%',
        height: 80,
    ...
    pointerEventsNone: pointerEventsNone_1.default,
    pointerEventsAuto: pointerEventsAuto_1.default,
    pointerEventsBoxNone: pointerEventsBoxNone_1.default,
    headerBar: {
        overflow: 'hidden',
        justifyContent: 'center',
        display: 'flex',
    ...
    reportDetailsTitleContainer: {
        ...display_1.default.dFlex,
        ...flex_1.default.flexColumn,
        ...flex_1.default.alignItemsCenter,
        paddingHorizontal: 20,
    },
    ...
    twoFactorAuthCodesBox: ({ isExtraSmallScreenWidth, isSmallScreenWidth }) => {
        let paddingHorizontal = spacing_1.default.ph9;
    ...
    workspaceUpgradeIntroBox: ({ isExtraSmallScreenWidth }) => {
        let paddingHorizontal = spacing_1.default.ph5;
        let paddingVertical = spacing_1.default.pv5;
        if (isExtraSmallScreenWidth) {
            paddingHorizontal = spacing_1.default.ph2;
    ...
    rootNavigatorContainerStyles: (isSmallScreenWidth) => ({ marginLeft: isSmallScreenWidth ? 0 : variables_1.default.sideBarWithLHBWidth + variables_1.default.navigationTabBarSize, flex: 1 }),
    RHPNavigatorContainerNavigatorContainerStyles: (isSmallScreenWidth) => ({ marginLeft: isSmallScreenWidth ? 0 : variables_1.default.sideBarWidth, flex: 1 }),
    avatarInnerTextChat: {
        color: theme.text,
        fontSize: variables_1.default.fontSizeXLarge,
        ...FontUtils_1.default.fontFamily.platform.EXP_NEW_KANSAS_MEDIUM,
    ...
    accountSettingsSectionContainer: {
        ...
        ...spacing_1.default.mt0,
        ...spacing_1.default.mb0,
        ...spacing_1.default.pt0,
    },
    centralPaneAnimation: {
        height: CONST_1.default.CENTRAL_PANE_ANIMATION_HEIGHT,
    },
    sectionTitle: {
        ...spacing_1.default.pv2,
    ...
    unreadIndicatorContainer: {
        ...
        alignItems: 'center',
        zIndex: 1,
        ...cursor_1.default.cursorDefault,
    },
    ...
    dividerLine: {
        ...
        backgroundColor: theme.border,
        flexGrow: 1,
        ...spacing_1.default.mh5,
        ...spacing_1.default.mv3,
    },
    sectionDividerLine: {
        height: 1,
        backgroundColor: theme.border,
    ...
    screenWrapperContainer: (minHeight) => ({
        flex: 1,
        minHeight,
        backgroundColor: theme.appBG,
    }),
    ...
    iouAmountText: {
        ...headlineFont,
        fontSize: variables_1.default.iouAmountTextSize,
        color: theme.heading,
        lineHeight: variables_1.default.inputHeight,
    },
    iouAmountTextInput: (0, addOutlineWidth_1.default)(theme, {
        ...headlineFont,
        fontSize: variables_1.default.iouAmountTextSize,
        color: theme.heading,
        lineHeight: undefined,
    ...
    moneyRequestConfirmationAmount: {
        ...headlineFont,
        fontSize: variables_1.default.fontSizeH1,
    },
    ...
    moneyRequestAmountContainer: { minHeight: variables_1.default.inputHeight + 2 * (variables_1.default.formErrorLineHeight + 8) },
    requestPreviewBox: {
        marginTop: 12,
    ...
    growlNotificationContainer: {
        ...
        width: '100%',
        top: 20,
        ...spacing_1.default.pl5,
        ...spacing_1.default.pr5,
    },
    ...
    growlNotificationTranslateY: (translateY) => {
        'worklet';
        return {
            transform: [{ translateY: translateY.get() }],
        };
    ...
    sliderKnob: {
        ...
        width: variables_1.default.sliderKnobSize,
        borderRadius: variables_1.default.sliderKnobSize / 2,
        left: -(variables_1.default.sliderKnobSize / 2),
        ...cursor_1.default.cursorPointer,
    },
    sliderBar: {
        backgroundColor: theme.border,
    ...
    activeDropzoneDashedBorder: (borderColor, isActive) => {
        ...
        const isSafariOrChromeBrowser = (0, getPlatform_1.default)() === CONST_1.default.PLATFORM.WEB && (browser === CONST_1.default.BROWSER.SAFARI || browser === CONST_1.default.BROWSER.CHROME);
        return {
            position: 'absolute',
            top: 0,
            left: 0,
    ...
    attachmentDropOverlay: (isActive) => ({
    ...
    fileUploadImageWrapper: (fileTopPosition) => ({
        position: 'absolute',
        top: fileTopPosition,
    }),
    ...
    stickyHeaderEmoji: (isSmallScreenWidth, windowWidth) => ({
        position: 'absolute',
    ...
    reactionListContainer: {
        maxHeight: variables_1.default.listItemHeightNormal * 5.75,
        ...spacing_1.default.pv2,
    },
    ...
    eReceiptAmountLarge: {
        ...headlineFont,
        fontSize: variables_1.default.fontSizeEReceiptLarge,
        textAlign: 'center',
    },
    eReceiptCurrency: {
        ...headlineFont,
    ...
    eReceiptPanel: {
        ...spacing_1.default.p5,
        ...spacing_1.default.pb8,
        ...spacing_1.default.m5,
    ...
    eReceiptContentContainer: {
        ...sizing_1.default.w100,
        ...spacing_1.default.p5,
        minWidth: variables_1.default.eReceiptBodyWidth,
        minHeight: variables_1.default.eReceiptBodyHeight,
    },
    eReceiptContentWrapper: {
        ...sizing_1.default.w100,
        ...spacing_1.default.ph5,
        ...spacing_1.default.pt10,
        ...spacing_1.default.pb4,
        ...sizing_1.default.h100,
        position: 'absolute',
        left: 0,
    },
    loginHeroBody: {
        ...FontUtils_1.default.fontFamily.platform.EXP_NEUE,
        fontSize: variables_1.default.fontSizeSignInHeroBody,
        color: theme.textLight,
        textAlign: 'center',
    },
    linkPreviewWrapper: {
    ...
    taskTitleMenuItem: {
        ...
        ...headlineFont,
        fontSize: variables_1.default.fontSizeXLarge,
        lineHeight: variables_1.default.lineHeighTaskTitle,
        maxWidth: '100%',
        ...wordBreak_1.default.breakWord,
    ...
    taskTitleDescription: {
        ...
        color: theme.textSupporting,
        lineHeight: variables_1.default.lineHeightNormal,
        ...spacing_1.default.mb1,
    },
    taskMenuItemCheckbox: {
        height: 27,
        ...spacing_1.default.mr3,
    },
    ...
    assigneeTextStyle: {
        ...FontUtils_1.default.fontFamily.platform.EXP_NEUE_BOLD,
        minHeight: variables_1.default.avatarSizeSubscript,
    },
    taskRightIconContainer: {
        width: variables_1.default.componentSizeNormal,
        marginLeft: 'auto',
        ...spacing_1.default.mt1,
        ...pointerEventsAuto_1.default,
        ...display_1.default.dFlex,
        ...flex_1.default.alignItemsCenter,
    },
    shareCodeContainer: {
    ...
    tabText: (isSelected, hasIcon = false) => ({
    ...
    tabOpacity: (hovered, isFocused, activeOpacityValue, inactiveOpacityValue) => ({
    ...
    dropDownButtonCartIconView: {
        borderTopRightRadius: variables_1.default.buttonBorderRadius,
        borderBottomRightRadius: variables_1.default.buttonBorderRadius,
        ...flex_1.default.flexRow,
        ...flex_1.default.alignItemsCenter,
    },
    ...
    emojiStatusLHN: {
        fontSize: 9,
        ...((0, Browser_1.getBrowser)() && !(0, Browser_1.isMobile)() && { transform: 'scale(.5)', fontSize: 22, overflow: 'visible' }),
        ...((0, Browser_1.getBrowser)() &&
    ...
    justSignedInModalAnimation: (is2FARequired) => ({
    ...
    currentPositionDot: { backgroundColor: colors_1.default.blue400, width: 16, height: 16, borderRadius: 16 },
    mapViewOverlay: {
        flex: 1,
        position: 'absolute',
        left: 0,
    ...
    aspectRatioLottie: (animation) => ({ aspectRatio: animation.w / animation.h }),
    ...
    colorSchemeStyle: (colorScheme) => ({ colorScheme }),
    updateAnimation: {
    ...
    emptyStateHeader: (isIllustration) => ({
    ...
    sidePanelOverlay: (isOverlayVisible) => ({
        ...positioning_1.default.pFixed,
        top: 0,
        bottom: 0,
        left: 0,
        right: -variables_1.default.sideBarWidth,
        backgroundColor: theme.overlay,
        opacity: isOverlayVisible ? 0 : variables_1.default.overlayOpacity,
    }),
    sidePanelContent: (shouldUseNarrowLayout, isExtraLargeScreenWidth) => ({
        position: react_native_1.Platform.OS === 'web' ? 'fixed' : 'absolute',
        top: 0,
        bottom: 0,
        right: 0,
    ...
    getSearchBarStyle: (shouldUseNarrowLayout) => ({
        maxWidth: shouldUseNarrowLayout ? '100%' : 300,
        marginHorizontal: 20,
        marginBottom: 20,
    }),
    getSelectionListPopoverHeight: (itemCount, windowHeight, isSearchable) => {
        const SEARCHBAR_HEIGHT = isSearchable ? 52 : 0;
        const SEARCHBAR_PADDING = isSearchable ? 12 : 0;
        const PADDING = 32;
        const GAP = 8;
        const BUTTON_HEIGHT = 40;
        const ESTIMATED_LIST_HEIGHT = itemCount * variables_1.default.optionRowHeightCompact + SEARCHBAR_HEIGHT + SEARCHBAR_PADDING;
        const MAX_HEIGHT = CONST_1.default.POPOVER_DROPDOWN_MAX_HEIGHT - (PADDING + GAP + BUTTON_HEIGHT);
    ...
    getUserSelectionListPopoverHeight: (itemCount, windowHeight, shouldUseNarrowLayout) => {
        const BUTTON_HEIGHT = 40;
        const SEARCHBAR_HEIGHT = 50;
        const SEARCHBAR_MARGIN = 14;
        const PADDING = 44 - (shouldUseNarrowLayout ? 32 : 0);
        const ESTIMATED_LIST_HEIGHT = itemCount * variables_1.default.optionRowHeightCompact + SEARCHBAR_HEIGHT + SEARCHBAR_MARGIN + BUTTON_HEIGHT + PADDING;
        // Native platforms don't support maxHeight in the way thats expected, so lets manually set the height to either
        // the listHeight, the max height of the popover, or 90% of the window height, such that we never overflow the screen
        // and never expand over the max height
        const height = Math.min(ESTIMATED_LIST_HEIGHT, CONST_1.default.POPOVER_DROPDOWN_MAX_HEIGHT, windowHeight * 0.9);
        const width = shouldUseNarrowLayout ? sizing_1.default.w100 : { width: CONST_1.default.POPOVER_DROPDOWN_WIDTH };
        return { height, ...width };
    },
    earlyDiscountButton: {
        flexGrow: 1,
    ...
    testDriveModalContainer: (shouldUseNarrowLayout) => ({
    ...
    getTestToolsNavigatorOuterView: (shouldUseNarrowLayout) => ({
        flex: 1,
        justifyContent: shouldUseNarrowLayout ? 'flex-end' : 'center',
        alignItems: 'center',
    }),
    getTestToolsNavigatorInnerView: (shouldUseNarrowLayout, isAuthenticated) => {
        const borderBottomRadius = shouldUseNarrowLayout ? 0 : variables_1.default.componentBorderRadiusLarge;
...
const defaultStyles = styles(theme_1.defaultTheme);
