...
var styles = function (theme) {
    return (__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, spacing_1.default), borders_1.default), sizing_1.default), flex_1.default), display_1.default), overflow_1.default), positioning_1.default), wordBreak_1.default), translateZ0_1.default), whiteSpace_1.default), writingDirection_1.default), cursor_1.default), userSelect_1.default), textUnderline_1.default), objectFit_1.default), textDecorationLine_1.default), { editedLabelStyles: editedLabelStyles_1.default, emojiDefaultStyles: emojiDefaultStyles_1.default, autoCompleteSuggestionsContainer: {
            ...
            lineHeight: 14,
        }, webViewStyles: webViewStyles(theme), link: link(theme), emailLink: emailLink(theme), highlightBG: {
        ...
        sidebar: {
        ...
        }, modalStackNavigatorContainer: function (isSmallScreenWidth) { return ({
            width: isSmallScreenWidth ? '100%' : variables_1.default.sideBarWidth,
            height: '100%',
            right: 0,
            position: react_native_1.Platform.OS === 'web' ? 'fixed' : 'absolute',
        }); }, animatedRHPNavigatorContainer: function (shouldUseNarrowLayout, expandedRHPProgress) { return ({
            height: '100%',
            ...
            var progress = _a.progress, _b = _a.hasMarginRight, hasMarginRight = _b === void 0 ? false : _b, _c = _a.hasMarginLeft, hasMarginLeft = _c === void 0 ? false : _c;
            return (__assign(__assign({}, positioning_1.default.pFixed), { 
                // We need to stretch the overlay to cover the sidebar and the translate animation distance.
                left: hasMarginLeft ? variables_1.default.receiptPaneRHPMaxWidth : -2 * variables_1.default.sideBarWidth, top: 0, bottom: 0, right: hasMarginRight ? variables_1.default.sideBarWidth : 0, backgroundColor: theme.overlay, opacity: progress.interpolate({
                    inputRange: [0, 1],
        ...
        }, screenWrapperContainer: function (minHeight) { return ({
            flex: 1,
            minHeight: minHeight,
            backgroundColor: theme.appBG,
        ...
        inputTransparent: __assign({ color: 'transparent' }, ((0, Browser_1.getBrowser)()
            ...
            justifyContent: 'flex-start',
            marginTop: 10,
        }, peopleRow: __assign({ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, spacing_1.default.ph5), offlineFeedback: {
            deleted: {
                textDecorationLine: 'line-through',
                textDecorationStyle: 'solid',
            },
            ...
            return __assign(__assign({ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, width: '100%', height: '100%', opacity: isActive ? 1 : 0, transition: 'opacity 0.2s ease-in' }, (isSafariOrChromeBrowser && {
            ...
            flexShrink: 1,
            flexBasis: '35%',
        }, aspectRatioLottie: function (animation) { return ({ aspectRatio: animation.w / animation.h }); }, checkboxWithLabelCheckboxStyle: {
            marginLeft: -2,
