...
var home_background__ios_svg_1 = require("@assets/images/home-background--ios.svg");
...
function BackgroundImage(_a) {
    var width = _a.width, transitionDuration = _a.transitionDuration;
    ...
    return (<react_native_reanimated_1.default.View style={[styles.signInBackground, StyleUtils.getWidthStyle(width), animatedStyle]}>
            <expo_image_1.Image source={home_background__ios_svg_1.default} onLoadEnd={function () { return setOpacityAnimation(); }} style={[styles.signInBackground, StyleUtils.getWidthStyle(width)]} transition={transitionDuration}/>
