...
function IntroSchoolPrincipalPage() {
    ...
    var onSubmit = function (values) {
        ...
        TeachersUnite_1.default.addSchoolPrincipal(values.firstName.trim(), values.partnerUserID.trim(), values.lastName.trim(), policyID, localCurrencyCode, login !== null && login !== void 0 ? login : '', accountID);
    };
    /**
