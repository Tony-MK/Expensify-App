...
function ReportChangeWorkspacePage(_a) {
    ...
    var _d = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.POLICY, { canBeMissing: true }), policies = _d[0], fetchStatus = _d[1];
    ...
    var selectPolicy = (0, react_1.useCallback)(function (policyID) {
        ...
        else if ((0, ReportUtils_1.isIOUReport)(reportID) && (0, PolicyUtils_1.isPolicyMember)(policy, session === null || session === void 0 ? void 0 : session.email)) {
    ...
    }, [session === null || session === void 0 ? void 0 : session.email, route.params, report, reportID, reportNextStep, policies, formatPhoneNumber, isReportArchived]);
