...
function SplitExpensePage(_a) {
    ...
    var _k = (0, useDisplayFocusedInputUnderKeyboard_1.default)(), listRef = _k.listRef, viewRef = _k.viewRef, footerRef = _k.footerRef, bottomOffset = _k.bottomOffset, scrollToFocusedInput = _k.scrollToFocusedInput, SplitListItem = _k.SplitListItem;
    var _l = route.params, reportID = _l.reportID, transactionID = _l.transactionID, splitExpenseTransactionID = _l.splitExpenseTransactionID, backTo = _l.backTo;
    var shouldUseNarrowLayout = (0, useResponsiveLayout_1.default)().shouldUseNarrowLayout;
    var _m = react_1.default.useState(''), errorMessage = _m[0], setErrorMessage = _m[1];
    ...
    }, [draftTransaction, sumOfSplitExpenses, transactionDetailsAmount, isPerDiem, isCard, currentSearchHash, transactionID, translate, transactionDetails === null || transactionDetails === void 0 ? void 0 : transactionDetails.currency]);
    ...
    var footerContent = (0, react_1.useMemo)(function () {
        var shouldShowWarningMessage = sumOfSplitExpenses < Math.abs(transactionDetailsAmount);
