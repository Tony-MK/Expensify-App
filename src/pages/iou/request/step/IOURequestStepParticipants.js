...
function IOURequestStepParticipants(_a) {
    ...
    var iouRequestType = (0, TransactionUtils_1.getRequestType)(initialTransaction, isBetaEnabled(CONST_1.default.BETAS.MANUAL_DISTANCE));
    ...
    var addParticipant = (0, react_1.useCallback)(function (val) {
        ...
        if (!isMovingTransactionFromTrackExpense) {
            ...
            var rateID_1 = DistanceRequestUtils_1.default.getCustomUnitRateID({ reportID: firstParticipantReportID, isPolicyExpenseChat: isPolicyExpenseChat, policy: policy, lastSelectedDistanceRates: lastSelectedDistanceRates });
            transactions.forEach(function (transaction) {
