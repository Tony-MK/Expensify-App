...
function IOURequestStepScan(_a) {
    ...
    var _l = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_MUTED_PLATFORMS, { canBeMissing: true })[0], mutedPlatforms = _l === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _l;
    ...
    var setReceiptFilesAndNavigate = function (files) {
        ...
        files.forEach(function (file, index) {
            ...
            newReceiptFiles.push({ file: file, source: (_c = file.uri) !== null && _c !== void 0 ? _c : '', transactionID: transactionID });
            // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
            (0, IOU_1.setMoneyRequestReceipt)(transactionID, (_d = file.uri) !== null && _d !== void 0 ? _d : '', file.name || '', true);
        });
        if (shouldSkipConfirmation) {
    ...
    var capturePhoto = (0, react_1.useCallback)(function () {
        ...
        react_native_blob_util_1.default.fs
            ...
            (_a = camera === null || camera === void 0 ? void 0 : camera.current) === null || _a === void 0 ? void 0 : _a.takePhoto({
                ...
                (0, cropImageToAspectRatio_1.cropImageToAspectRatio)(imageObject, (_c = viewfinderLayout.current) === null || _c === void 0 ? void 0 : _c.width, (_d = viewfinderLayout.current) === null || _d === void 0 ? void 0 : _d.height).then(function (_a) {
                    var filename = _a.filename, source = _a.source;
                    (0, IOU_1.setMoneyRequestReceipt)(transactionID, source, filename, !isEditing);
                    (0, FileUtils_1.readFileAsync)(source, filename, function (file) {
                        if (isEditing) {
                ...
                <react_native_1.View style={[styles.flex1]}>
                    ...
                    {cameraPermissionStatus === react_native_permissions_1.RESULTS.GRANTED && device != null && (<react_native_1.View style={[styles.cameraView]}>
                            <react_native_gesture_handler_1.GestureDetector gesture={tapGesture}>
                                <react_native_1.View style={styles.flex1}>
                                    <Camera_1.default key={cameraKey} ref={camera} device={device} style={styles.flex1} zoom={device.neutralZoom} photo cameraTabIndex={1} onLayout={function (e) { return (viewfinderLayout.current = e.nativeEvent.layout); }}/>
