...
function IOURequestStepDestination(_a) {
    ...
    var tabTitles = (_b = {},
        ...
        _b);
    return (<ScreenWrapper_1.default includePaddingTop={false} keyboardVerticalOffset={variables_1.default.contentHeaderHeight + top + variables_1.default.tabSelectorButtonHeight + variables_1.default.tabSelectorButtonPadding} testID={"".concat(IOURequestStepDestination.displayName, "-container")}>
