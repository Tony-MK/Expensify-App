...
function IOURequestStepSplitPayer(_a) {
    ...
    var sections = (0, react_1.useMemo)(function () {
        ...
        var participantOptions = (_d = (_c = (_b = __spreadArray([currentUserOption], participants, true)) === null || _b === void 0 ? void 0 : _b.filter(function (participant) { return !!participant.accountID; })) === null || _c === void 0 ? void 0 : _c.map(function (participant) { return (0, OptionsListUtils_1.getParticipantsOption)(participant, personalDetails); })) !== null && _d !== void 0 ? _d : [];
        return [
            {
                title: '',
                data: participantOptions.map(function (participantOption) {
                    var _a, _b;
                    return (__assign(__assign({}, participantOption), { isSelected: !!(transaction === null || transaction === void 0 ? void 0 : transaction.splitPayerAccountIDs) && ((_a = transaction === null || transaction === void 0 ? void 0 : transaction.splitPayerAccountIDs) === null || _a === void 0 ? void 0 : _a.includes((_b = participantOption.accountID) !== null && _b !== void 0 ? _b : CONST_1.default.DEFAULT_NUMBER_ID)) }));
                }),
            },
        ];
    ...
    var setSplitPayerAction = function (item) {
        var _a;
        (0, IOU_1.setSplitPayer)(transactionID, (_a = item.accountID) !== null && _a !== void 0 ? _a : CONST_1.default.DEFAULT_NUMBER_ID);
        navigateBack();
    };
