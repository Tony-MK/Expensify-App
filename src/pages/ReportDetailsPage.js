...
function ReportDetailsPage(_a) {
    ...
    var _l = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_DEBUG_MODE_ENABLED, { canBeMissing: true })[0], isDebugModeEnabled = _l === void 0 ? false : _l;
    ...
    var _m = (0, react_1.useState)(false), isLastMemberLeavingGroupModalVisible = _m[0], setIsLastMemberLeavingGroupModalVisible = _m[1];
    var _o = (0, react_1.useState)(false), isDeleteModalVisible = _o[0], setIsDeleteModalVisible = _o[1];
    ...
    var reportAttributes = (0, useOnyx_1.default)(ONYXKEYS_1.default.DERIVED.REPORT_ATTRIBUTES, { canBeMissing: true, selector: function (val) { return val === null || val === void 0 ? void 0 : val.reports; } })[0];
    ...
    var renderedAvatar = (0, react_1.useMemo)(function () {
        ...
        icons,
        report.avatarUrl,
        (_c = report.pendingFields) === null || _c === void 0 ? void 0 : _c.avatar,
        (_d = report.errorFields) === null || _d === void 0 ? void 0 : _d.avatar,
        report.reportID,
        styles.avatarXLarge,
    ...
    var nameSectionGroupWorkspace = (<OfflineWithFeedback_1.default pendingAction={(_e = report === null || report === void 0 ? void 0 : report.pendingFields) === null || _e === void 0 ? void 0 : _e.reportName} errors={(_f = report === null || report === void 0 ? void 0 : report.errorFields) === null || _f === void 0 ? void 0 : _f.reportName} errorRowStyles={[styles.ph5]} onClose={function () { return (0, Report_1.clearPolicyRoomNameErrors)(report === null || report === void 0 ? void 0 : report.reportID); }}>
    ...
    var nameSectionTitleField = !!titleField && (<OfflineWithFeedback_1.default pendingAction={(_g = report.pendingFields) === null || _g === void 0 ? void 0 : _g.reportName} errors={(_h = report.errorFields) === null || _h === void 0 ? void 0 : _h.reportName} errorRowStyles={styles.ph5} key={"menuItem-".concat(fieldKey)} onClose={function () { return (0, Report_1.clearPolicyRoomNameErrors)(report.reportID); }}>
    ...
    var deleteTransaction = (0, react_1.useCallback)(function () {
        ...
        if (isTrackExpense) {
            (0, IOU_1.deleteTrackExpense)(moneyRequestReport === null || moneyRequestReport === void 0 ? void 0 : moneyRequestReport.reportID, iouTransactionID, requestParentReportAction, duplicateTransactions, duplicateTransactionViolations, isSingleTransactionView);
        }
        else {
    ...
    return (<ScreenWrapper_1.default testID={ReportDetailsPage.displayName}>
            <FullPageNotFoundView_1.default shouldShow={(0, EmptyObject_1.isEmptyObject)(report)}>
                ...
                <ScrollView_1.default contentContainerStyle={[styles.flexGrow1]}>
                    ...
                    {shouldShowReportDescription && (<OfflineWithFeedback_1.default pendingAction={(_j = report.pendingFields) === null || _j === void 0 ? void 0 : _j.description}>
