...
function useOptions() {
    ...
    var _c = (0, react_1.useState)(false), didScreenTransitionEnd = _c[0], setDidScreenTransitionEnd = _c[1];
    var contacts = (0, useContactImport_1.default)().contacts;
    var _d = (0, OptionListContextProvider_1.useOptionsList)({
        shouldInitialize: didScreenTransitionEnd,
    }), listOptions = _d.options, areOptionsInitialized = _d.areOptionsInitialized;
...
function NewChatPage(_, ref) {
    ...
    }, [debouncedSearchTerm, selectedOptions, recentReports, personalDetails, reportAttributesDerived, translate, userToInvite]), sections = _b[0], firstKeyForList = _b[1];
    /**
