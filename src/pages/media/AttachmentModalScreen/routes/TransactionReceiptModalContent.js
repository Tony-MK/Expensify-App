...
function TransactionReceiptModalContent(_a) {
    ...
    var _e = route.params, _f = _e.reportID, reportID = _f === void 0 ? '' : _f, _g = _e.transactionID, transactionID = _g === void 0 ? '' : _g, action = _e.action, iouType = _e.iouType, readonlyProp = _e.readonly, isFromReviewDuplicatesProp = _e.isFromReviewDuplicates;
    ...
    var readonly = readonlyProp === 'true';
    var isFromReviewDuplicates = isFromReviewDuplicatesProp === 'true';
