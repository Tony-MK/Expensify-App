...
function ComposerWithSuggestions(_a, ref) {
    ...
    // Composer
    isComposerFullSize = _a.isComposerFullSize, setIsFullComposerAvailable = _a.setIsFullComposerAvailable, isMenuVisible = _a.isMenuVisible, inputPlaceholder = _a.inputPlaceholder, displayFilesInModal = _a.displayFilesInModal, disabled = _a.disabled, setIsCommentEmpty = _a.setIsCommentEmpty, handleSendMessage = _a.handleSendMessage, shouldShowComposeInput = _a.shouldShowComposeInput, _d = _a.measureParentContainer, measureParentContainer = _d === void 0 ? function () { } : _d, isScrollLikelyLayoutTriggered = _a.isScrollLikelyLayoutTriggered, raiseIsScrollLikelyLayoutTriggered = _a.raiseIsScrollLikelyLayoutTriggered, _e = _a.onCleared, onCleared = _e === void 0 ? function () { } : _e, onLayoutProps = _a.onLayout, 
    // Refs
