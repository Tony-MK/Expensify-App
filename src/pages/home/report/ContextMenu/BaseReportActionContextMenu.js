...
function BaseReportActionContextMenu(_a) {
    ...
    var _q = (0, useResponsiveLayout_1.default)(), shouldUseNarrowLayout = _q.shouldUseNarrowLayout, isSmallScreenWidth = _q.isSmallScreenWidth;
    var menuItemRefs = (0, react_1.useRef)({});
    var _r = (0, react_1.useState)(false), shouldKeepOpen = _r[0], setShouldKeepOpen = _r[1];
    ...
    var _s = (0, useArrowKeyFocusManager_1.default)({
        initialFocusedIndex: -1,
        disabledIndexes: disabledIndexes,
        maxIndex: filteredContextMenuActions.length - 1,
        isActive: shouldEnableArrowNavigation,
    }), focusedIndex = _s[0], setFocusedIndex = _s[1];
    /**
