...
function ReportActionItemMessageEdit(_a, forwardedRef) {
    ...
    var _k = (0, useOnyx_1.default)(ONYXKEYS_1.default.MODAL, { canBeMissing: true })[0], modal = _k === void 0 ? DEFAULT_MODAL_VALUE : _k;
    var _l = (0, useOnyx_1.default)(ONYXKEYS_1.default.INPUT_FOCUSED, { canBeMissing: true })[0], onyxInputFocused = _l === void 0 ? false : _l;
    var _m = (0, useScrollBlocker_1.default)(), isScrolling = _m.isScrolling, startScrollBlock = _m.startScrollBlock, endScrollBlock = _m.endScrollBlock;
