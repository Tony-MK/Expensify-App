...
function ReportActionsView(_a) {
    ...
    var transactionThreadReportActions = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(transactionThreadReportID), {
        selector: function (reportActions) { return (0, ReportActionsUtils_1.getSortedReportActionsForDisplay)(reportActions, (0, ReportUtils_1.canUserPerformWriteAction)(report, isReportArchived), true); },
        canBeMissing: true,
    })[0];
    ...
    var _d = (0, react_1.useState)(!!reportActionID), isNavigatingToLinkedMessage = _d[0], setNavigatingToLinkedMessage = _d[1];
    ...
    var _e = (0, useLoadReportActions_1.default)({
        reportID: reportID,
    ...
    }), loadOlderChats = _e.loadOlderChats, loadNewerChats = _e.loadNewerChats;
    /**
