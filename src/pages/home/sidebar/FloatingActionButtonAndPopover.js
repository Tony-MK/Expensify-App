...
function FloatingActionButtonAndPopover(_a) {
    var _b;
    var onHideCreateMenu = _a.onHideCreateMenu, onShowCreateMenu = _a.onShowCreateMenu, isTooltipAllowed = _a.isTooltipAllowed, ref = _a.ref;
    ...
    var _e = (0, react_1.useState)(false), isCreateMenuActive = _e[0], setIsCreateMenuActive = _e[1];
    ...
    var _h = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.POLICY, {
        canBeMissing: true,
    ...
    })[0], isUserPaidPolicyMember = _h === void 0 ? false : _h;
                        ...
                        if (!(0, SubscriptionUtils_1.shouldRestrictUserBillableActions)(workspaceIDForReportCreation)) {
                            ...
                            Navigation_1.default.setNavigationActionToMicrotaskQueue(function () {
                                Navigation_1.default.navigate((0, isSearchTopmostFullScreenRoute_1.default)()
                                    ...
                                    : ROUTES_1.default.REPORT_WITH_ID.getRoute(createdReportID_1, undefined, undefined, Navigation_1.default.getActiveRoute()));
                            });
                        }
                        else {
        ...
        ? [
            {
                ...
                onSelected: function () {
                    return (0, interceptAnonymousUser_1.default)(function () { var _a; return (0, Tour_1.startTestDrive)(introSelected, (0, Session_1.isAnonymousUser)(), (_a = tryNewDot === null || tryNewDot === void 0 ? void 0 : tryNewDot.hasBeenAddedToNudgeMigration) !== null && _a !== void 0 ? _a : false, isUserPaidPolicyMember); });
                },
            },
        ]
