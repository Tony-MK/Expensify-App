...
function ReportScreen(_a) {
    ...
    var _g = (0, react_1.useState)(true), firstRender = _g[0], setFirstRender = _g[1];
    ...
    var _j = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_IS_COMPOSER_FULL_SIZE).concat(reportIDFromRoute), { canBeMissing: true })[0], isComposerFullSize = _j === void 0 ? false : _j;
    ...
    var _k = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_USER_IS_LEAVING_ROOM).concat(reportIDFromRoute), { canBeMissing: true })[0], userLeavingStatus = _k === void 0 ? false : _k;
    ...
    var _l = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_METADATA).concat(reportIDFromRoute), { canBeMissing: true, allowStaleData: true })[0], reportMetadata = _l === void 0 ? defaultReportMetadata : _l;
    var _m = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.POLICY, { allowStaleData: true, canBeMissing: false })[0], policies = _m === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _m;
    ...
    var _t = (0, ReportUtils_1.getReportOfflinePendingActionAndErrors)(report), reportPendingAction = _t.reportPendingAction, reportErrors = _t.reportErrors;
    ...
    var _u = (0, useTransactionsAndViolationsForReport_1.default)(reportIDFromRoute), allReportTransactions = _u.transactions, allReportViolations = _u.violations;
    ...
    var _v = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(transactionThreadReportID), {
        canBeMissing: true,
    })[0], transactionThreadReportActions = _v === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _v;
    ...
    var _w = (0, useIsReportReadyToDisplay_1.default)(report, reportIDFromRoute, isReportArchived), isEditingDisabled = _w.isEditingDisabled, isCurrentReportLoadedFromOnyx = _w.isCurrentReportLoadedFromOnyx;
