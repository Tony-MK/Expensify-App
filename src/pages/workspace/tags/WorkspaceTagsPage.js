...
function WorkspaceTagsPage(_a) {
    ...
    var _k = (0, react_1.useMemo)(function () { return [(0, PolicyUtils_1.getTagLists)(policyTags), (0, PolicyUtils_1.isMultiLevelTags)(policyTags), (0, PolicyUtils_1.hasDependentTags)(policy, policyTags), (0, PolicyUtils_1.hasIndependentTags)(policy, policyTags)]; }, [policy, policyTags]), policyTagLists = _k[0], isMultiLevelTags = _k[1], hasDependentTags = _k[2], hasIndependentTags = _k[3];
    ...
    var _l = (0, react_1.useState)([]), selectedTags = _l[0], setSelectedTags = _l[1];
