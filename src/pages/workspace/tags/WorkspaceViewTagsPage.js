...
function WorkspaceViewTagsPage(_a) {
    ...
    var _j = (0, react_1.useState)(false), isDeleteTagsConfirmModalVisible = _j[0], setIsDeleteTagsConfirmModalVisible = _j[1];
    ...
    var _k = (0, react_1.useState)(false), isCannotMakeAllTagsOptionalModalVisible = _k[0], setIsCannotMakeAllTagsOptionalModalVisible = _k[1];
    var _l = (0, react_1.useState)(false), isCannotDeleteOrDisableLastTagModalVisible = _l[0], setIsCannotDeleteOrDisableLastTagModalVisible = _l[1];
    ...
    var _m = (0, useFilteredSelection_1.default)(currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.tags, filterFunction), selectedTags = _m[0], setSelectedTags = _m[1];
