...
var WorkspaceRowSkeleton_1 = require("@components/Skeletons/WorkspaceRowSkeleton");
...
function WorkspacesListPage() {
    ...
    var _f = (0, react_1.useState)(), policyIDToDelete = _f[0], setPolicyIDToDelete = _f[1];
    var _g = (0, react_1.useState)(), policyNameToDelete = _g[0], setPolicyNameToDelete = _g[1];
    var _h = (0, usePayAndDowngrade_1.default)(setIsDeleteModalOpen), setIsDeletingPaidWorkspace = _h.setIsDeletingPaidWorkspace, isLoadingBill = _h.isLoadingBill;
    var _j = (0, react_1.useState)(null), loadingSpinnerIconIndex = _j[0], setLoadingSpinnerIconIndex = _j[1];
    ...
    var _k = (0, react_1.useState)(false), isSupportalActionRestrictedModalOpen = _k[0], setIsSupportalActionRestrictedModalOpen = _k[1];
    ...
    var getMenuItem = (0, react_1.useCallback)(function (_a) {
        ...
        var defaultApprover = (0, PolicyUtils_1.getDefaultApprover)(policies === null || policies === void 0 ? void 0 : policies["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(item.policyID)]);
        if (!(isAdmin || isOwner) && defaultApprover !== (session === null || session === void 0 ? void 0 : session.email)) {
    ...
    var _l = (0, useSearchResults_1.default)(workspaces, filterWorkspace, sortWorkspace), inputValue = _l[0], setInputValue = _l[1], filteredWorkspaces = _l[2];
    ...
    return (<ScreenWrapper_1.default shouldEnablePickerAvoiding={false} shouldShowOfflineIndicatorInWideScreen testID={WorkspacesListPage.displayName} enableEdgeToEdgeBottomSafeAreaPadding={false} bottomContent={shouldUseNarrowLayout && <NavigationTabBar_1.default selectedTab={NAVIGATION_TABS_1.default.WORKSPACES}/>}>
            <react_native_1.View style={styles.flex1}>
                ...
                <react_native_1.FlatList ref={flatlistRef} data={filteredWorkspaces} onScrollToIndexFailed={function (info) {
            var _a;
