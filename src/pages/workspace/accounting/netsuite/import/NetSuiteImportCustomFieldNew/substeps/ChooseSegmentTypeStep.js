...
const NetSuiteCustomSegmentMappingPicker_1 = require("@pages/workspace/accounting/netsuite/import/NetSuiteImportCustomFieldNew/NetSuiteCustomSegmentMappingPicker");
const ONYXKEYS_1 = require("@src/ONYXKEYS");
const NetSuiteCustomFieldForm_1 = require("@src/types/form/NetSuiteCustomFieldForm");
const STEP_FIELDS = [NetSuiteCustomFieldForm_1.default.SEGMENT_TYPE];
function ChooseSegmentTypeStep({ onNext, setCustomSegmentType, isEditing, netSuiteCustomFieldFormValues }) {
    ...
    const handleSubmit = (0, useNetSuiteImportAddCustomSegmentForm_1.default)({
        ...
        onNext: () => {
            setCustomSegmentType?.(netSuiteCustomFieldFormValues[NetSuiteCustomFieldForm_1.default.SEGMENT_TYPE]);
            onNext();
        },
