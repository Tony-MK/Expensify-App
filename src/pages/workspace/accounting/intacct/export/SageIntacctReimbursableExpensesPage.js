...
function SageIntacctReimbursableExpensesPage({ policy }) {
    ...
    const defaultVendorName = (0, utils_1.getDefaultVendorName)(reimbursableExpenseReportDefaultVendor, intacctData?.vendors);
    const expandedCondition = !(reimbursable !== CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT || !reimbursableExpenseReportDefaultVendor);
    ...
    const menuItems = [
        ...
        },
        {
            ...
            onToggle: (enabled) => {
                ...
                (0, SageIntacct_1.updateSageIntacctDefaultVendor)(policyID, CONST_1.default.SAGE_INTACCT_CONFIG.REIMBURSABLE_VENDOR, vendor ?? '', config?.export.reimbursableExpenseReportDefaultVendor);
                isAccordionExpanded.set(enabled);
                shouldAnimateAccordionSection.set(true);
            },
            onCloseError: () => (0, Policy_1.clearSageIntacctErrorField)(policyID, CONST_1.default.SAGE_INTACCT_CONFIG.REIMBURSABLE_VENDOR),
            pendingAction: (0, PolicyUtils_1.settingsPendingAction)([CONST_1.default.SAGE_INTACCT_CONFIG.REIMBURSABLE_VENDOR], config?.pendingFields),
    ...
    return (<ConnectionLayout_1.default displayName={SageIntacctReimbursableExpensesPage.displayName} headerTitle="workspace.accounting.exportOutOfPocket" title="workspace.sageIntacct.reimbursableExpenses.description" onBackButtonPress={() => Navigation_1.default.goBack(backTo ?? (policyID && ROUTES_1.default.POLICY_ACCOUNTING_SAGE_INTACCT_EXPORT.getRoute(policyID)))} accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED} contentContainerStyle={styles.pb2} titleStyle={styles.ph5} connectionName={CONST_1.default.POLICY.CONNECTIONS.NAME.SAGE_INTACCT}>
            {menuItems
