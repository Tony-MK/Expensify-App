...
var ACCESS_VARIANTS = (_a = {},
    ...
    _a[CONST_1.default.IOU.ACCESS_VARIANTS.CREATE] = function (policy, login, report, allPolicies, iouType, isReportArchived) {
        return !!iouType &&
            ...
            ((0, EmptyObject_1.isEmptyObject)(report === null || report === void 0 ? void 0 : report.reportID) || (0, ReportUtils_1.canCreateRequest)(report, policy, iouType, isReportArchived)) &&
