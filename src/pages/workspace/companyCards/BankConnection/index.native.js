...
function BankConnection(_a) {
    ...
    var _u = (0, useUpdateFeedBrokenConnection_1.default)({ policyID: policyID, feed: feed }), updateBrokenConnection = _u.updateBrokenConnection, isFeedConnectionBroken = _u.isFeedConnectionBroken;
    ...
    }, [isNewFeedConnected, newFeed, policyID, url, feed, isFeedExpired, (_q = assignCard === null || assignCard === void 0 ? void 0 : assignCard.data) === null || _q === void 0 ? void 0 : _q.dateOption, isPlaid, onImportPlaidAccounts, isFeedConnectionBroken, updateBrokenConnection]);
