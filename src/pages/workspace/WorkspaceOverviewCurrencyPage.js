...
function WorkspaceOverviewCurrencyPage(_a) {
    ...
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.REIMBURSEMENT_ACCOUNT, { selector: function (value) { var _a; return ((_a = value === null || value === void 0 ? void 0 : value.achData) === null || _a === void 0 ? void 0 : _a.state) === CONST_1.default.BANK_ACCOUNT.STATE.OPEN; }, canBeMissing: true })[0], hasVBA = _b === void 0 ? false : _b;
