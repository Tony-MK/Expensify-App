...
function CategoryPayrollCodePage({ route }) {
    ...
    const isQuickSettingsFlow = route.name === SCREENS_1.default.SETTINGS_CATEGORIES.SETTINGS_CATEGORY_PAYROLL_CODE;
    const editPayrollCode = (0, react_1.useCallback)((values) => {
    ...
    const validate = (0, react_1.useCallback)((values) => {
        const errors = {};
        const value = values[WorkspaceCategoryForm_1.default.PAYROLL_CODE];
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.CONTROL]} policyID={route.params.policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CATEGORIES_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding style={[styles.defaultModalContainer]} testID={CategoryPayrollCodePage.displayName} shouldEnableMaxHeight>
                <HeaderWithBackButton_1.default title={translate('workspace.categories.payrollCode')} onBackButtonPress={() => Navigation_1.default.goBack(isQuickSettingsFlow
