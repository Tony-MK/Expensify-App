...
function WorkspaceCategoriesPage(_a) {
    ...
    var _h = (0, react_1.useState)(false), deleteCategoriesConfirmModalVisible = _h[0], setDeleteCategoriesConfirmModalVisible = _h[1];
    var _j = (0, react_1.useState)(false), isCannotDeleteOrDisableLastCategoryModalVisible = _j[0], setIsCannotDeleteOrDisableLastCategoryModalVisible = _j[1];
    ...
    var _l = (0, useSearchResults_1.default)(categoryList, filterCategory, sortCategories), inputValue = _l[0], setInputValue = _l[1], filteredCategoryList = _l[2];
