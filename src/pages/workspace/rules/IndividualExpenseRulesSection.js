...
function IndividualExpenseRulesSection(_a) {
    ...
    return (<Section_1.default isCentralPane title={translate('workspace.rules.individualExpenseRules.title')} renderSubtitle={function () { return (<IndividualExpenseRulesSectionSubtitle policy={policy} translate={translate} styles={styles} environmentURL={environmentURL}/>); }} titleStyles={styles.accountSettingsSectionTitle}>
            <react_native_1.View style={[styles.mt3]}>
                ...
                <react_native_1.View style={[styles.mt3]}>
                    <OfflineWithFeedback_1.default pendingAction={(_m = policy === null || policy === void 0 ? void 0 : policy.pendingFields) === null || _m === void 0 ? void 0 : _m.eReceipts}>
                ...
                <react_native_1.View style={[styles.mt3]}>
                    <OfflineWithFeedback_1.default pendingAction={(_o = policy === null || policy === void 0 ? void 0 : policy.pendingFields) === null || _o === void 0 ? void 0 : _o.isAttendeeTrackingEnabled}>
                        <react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, styles.justifyContentBetween, { minHeight: variables_1.default.h40 }]}>
