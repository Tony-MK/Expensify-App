...
function WorkspaceOverviewPage(_a) {
    ...
    var _m = (0, useOnyx_1.default)(ONYXKEYS_1.default.CURRENCY_LIST, { canBeMissing: true })[0], currencyList = _m === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _m;
    ...
    }, [policy === null || policy === void 0 ? void 0 : policy.id, policyName, lastAccessedWorkspacePolicyID, lastPaymentMethod]);
    ...
    var getHeaderButtons = function () {
        ...
        return (<react_native_1.View style={[!shouldUseNarrowLayout && styles.flexRow, !shouldUseNarrowLayout && styles.gap2]}>
                <ButtonWithDropdownMenu_1.default ref={dropdownMenuRef} success={false} onPress={function () { }} shouldAlwaysShowDropdownMenu customText={translate('common.more')} options={secondaryActions} isSplitButton={false} wrapperStyle={styles.flexGrow1}/>
            </react_native_1.View>);
    };
            ...
            return (<react_native_1.View style={[styles.flex1, styles.mt3, shouldUseNarrowLayout ? styles.workspaceSectionMobile : styles.workspaceSection]}>
                ...
                hasVBA || isBankAccountVerified
                    ...
                    {isBetaEnabled(CONST_1.default.BETAS.CUSTOM_RULES) ? (<Section_1.default isCentralPane title={translate('workspace.editor.policy')} titleStyles={[styles.textHeadline, styles.cardSectionTitle, styles.accountSettingsSectionTitle, styles.mb0]} subtitle={translate('workspace.rules.customRules.cardSubtitle')} subtitleStyles={[styles.mb6]} subtitleTextStyles={[styles.textNormal, styles.colorMuted, styles.mr5]} containerStyles={shouldUseNarrowLayout ? styles.p5 : styles.p8}>
                            <OfflineWithFeedback_1.default pendingAction={(_o = policy === null || policy === void 0 ? void 0 : policy.pendingFields) === null || _o === void 0 ? void 0 : _o.customRules}>
                                <MenuItemWithTopDescription_1.default title={(_p = policy === null || policy === void 0 ? void 0 : policy.customRules) !== null && _p !== void 0 ? _p : ''} description={translate('workspace.editor.policy')} shouldShowRightIcon={!readOnly} interactive={!readOnly} wrapperStyle={styles.sectionMenuItemTopDescription} onPress={function () { return Navigation_1.default.navigate(ROUTES_1.default.RULES_CUSTOM.getRoute(route.params.policyID)); }} shouldRenderAsHTML/>
                            </OfflineWithFeedback_1.default>
