...
function WorkspaceExpensifyCardListPage(_a) {
    ...
    var _f = (0, react_1.useContext)(DelegateNoAccessModalProvider_1.DelegateNoAccessContext), isActingAsDelegate = _f.isActingAsDelegate, showDelegateNoAccessModal = _f.showDelegateNoAccessModal;
    var _g = (0, react_1.useContext)(LockedAccountModalProvider_1.LockedAccountContext), isAccountLocked = _g.isAccountLocked, showLockedAccountModal = _g.showLockedAccountModal;
    ...
    var _h = (0, react_1.useState)(0), footerHeight = _h[0], setFooterHeight = _h[1];
    ...
    var _j = (0, useSearchResults_1.default)(allCards, filterCard, sortCards), inputValue = _j[0], setInputValue = _j[1], filteredSortedCards = _j[2];
    ...
    var renderItem = (0, react_1.useCallback)(function (_a) {
        ...
        return (<OfflineWithFeedback_1.default key={"".concat((_b = item.nameValuePairs) === null || _b === void 0 ? void 0 : _b.cardTitle, "_").concat(index)} pendingAction={item.pendingAction} errorRowStyles={styles.ph5} errors={item.errors} onClose={function () { return (0, PaymentMethods_1.clearDeletePaymentMethodError)("".concat(ONYXKEYS_1.default.COLLECTION.WORKSPACE_CARDS_LIST).concat(workspaceAccountID, "_").concat(CONST_1.default.EXPENSIFY_CARD.BANK), item.cardID); }}>
                <Pressable_1.PressableWithFeedback role={CONST_1.default.ROLE.BUTTON} style={[styles.mh5, styles.br3, styles.mb3, styles.highlightBG]} accessibilityLabel="row" hoverStyle={[styles.hoveredComponentBG]} onPress={function () { return Navigation_1.default.navigate(ROUTES_1.default.WORKSPACE_EXPENSIFY_CARD_DETAILS.getRoute(policyID, item.cardID.toString())); }}>
                    <WorkspaceCardListRow_1.default lastFourPAN={(_c = item.lastFourPAN) !== null && _c !== void 0 ? _c : ''} cardholder={personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails[(_d = item.accountID) !== null && _d !== void 0 ? _d : CONST_1.default.DEFAULT_NUMBER_ID]} limit={(_f = (_e = item.nameValuePairs) === null || _e === void 0 ? void 0 : _e.unapprovedExpenseLimit) !== null && _f !== void 0 ? _f : 0} name={(_h = (_g = item.nameValuePairs) === null || _g === void 0 ? void 0 : _g.cardTitle) !== null && _h !== void 0 ? _h : ''} currency={settlementCurrency} isVirtual={!!((_j = item.nameValuePairs) === null || _j === void 0 ? void 0 : _j.isVirtual)}/>
                </Pressable_1.PressableWithFeedback>
