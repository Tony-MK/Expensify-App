...
function WorkspaceExpensifyCardDetailsPage(_a) {
    ...
    var _u = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.WORKSPACE_CARDS_LIST, { canBeMissing: true }), allFeedsCards = _u[0], allFeedsCardsResult = _u[1];
    var workspaceCards = (0, CardUtils_1.getAllCardsForWorkspace)(workspaceAccountID !== null && workspaceAccountID !== void 0 ? workspaceAccountID : CONST_1.default.DEFAULT_NUMBER_ID, allFeedsCards, cardFeeds, expensifyCardSettings);
