...
function WorkspaceConfirmationPage() {
    ...
    var onSubmit = function (params) {
        ...
        (0, App_1.createWorkspaceWithPolicyDraftAndNavigateToIt)('', params.name, false, false, '', policyID, params.currency, params.avatarFile, routeToNavigate, lastPaymentMethod === null || lastPaymentMethod === void 0 ? void 0 : lastPaymentMethod[policyID]);
    };
