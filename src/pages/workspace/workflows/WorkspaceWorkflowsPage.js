...
function WorkspaceWorkflowsPage(_a) {
    ...
    var _h = (0, react_1.useState)(false), isUpdateWorkspaceCurrencyModalOpen = _h[0], setIsUpdateWorkspaceCurrencyModalOpen = _h[1];
    ...
    }, [personalDetails, policy, localeCompare]), approvalWorkflows = _j.approvalWorkflows, availableMembers = _j.availableMembers, usedApproverEmails = _j.usedApproverEmails;
        ...
        return [
            ...
            },
            {
                ...
                subMenuItems: !isOffline && (policy === null || policy === void 0 ? void 0 : policy.isLoadingWorkspaceReimbursement) === true ? (<react_native_1.ActivityIndicator size={CONST_1.default.ACTIVITY_INDICATOR_SIZE.LARGE} color={theme.spinner} style={styles.mt7}/>) : (<>
                        ...
                        (0, ReimbursementAccount_1.navigateToBankAccountRoute)(route.params.policyID, ROUTES_1.default.WORKSPACE_WORKFLOWS.getRoute(route.params.policyID));
                    }} icon={shouldShowBankAccount ? bankIcon.icon : Expensicons_1.Plus} iconHeight={shouldShowBankAccount ? ((_q = bankIcon.iconHeight) !== null && _q !== void 0 ? _q : bankIcon.iconSize) : 20} iconWidth={shouldShowBankAccount ? ((_r = bankIcon.iconWidth) !== null && _r !== void 0 ? _r : bankIcon.iconSize) : 20} iconStyles={shouldShowBankAccount ? bankIcon.iconStyles : undefined} disabled={isOffline || !isPolicyAdmin} shouldGreyOutWhenDisabled={!((_s = policy === null || policy === void 0 ? void 0 : policy.pendingFields) === null || _s === void 0 ? void 0 : _s.reimbursementChoice)} wrapperStyle={[styles.sectionMenuItemTopDescription, styles.mt3, styles.mbn3]} displayInDefaultIconColor={shouldShowBankAccount} brickRoadIndicator={hasReimburserError ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined}/>
