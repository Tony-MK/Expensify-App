...
function WorkspaceWorkflowsApprovalsApproverPage(_a) {
    var _b, _c, _d, _e, _f;
    var policy = _a.policy, personalDetails = _a.personalDetails, _g = _a.isLoadingReportData, isLoadingReportData = _g === void 0 ? true : _g, route = _a.route;
    ...
    var shouldShowListEmptyContent = !debouncedSearchTerm && !!approvalWorkflow && !((_f = sections.at(0)) === null || _f === void 0 ? void 0 : _f.data.length) && !isApprovalWorkflowLoading;
