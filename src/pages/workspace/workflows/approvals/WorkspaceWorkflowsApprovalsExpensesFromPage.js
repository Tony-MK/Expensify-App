...
function WorkspaceWorkflowsApprovalsExpensesFromPage(_a) {
    ...
    var _h = (0, useOnyx_1.default)(ONYXKEYS_1.default.APPROVAL_WORKFLOW, { canBeMissing: true }), approvalWorkflow = _h[0], approvalWorkflowResults = _h[1];
    ...
    var _j = (0, react_1.useState)([]), selectedMembers = _j[0], setSelectedMembers = _j[1];
    ...
    var sections = (0, react_1.useMemo)(function () {
        ...
        var filteredMembers = debouncedSearchTerm !== ''
            ? (0, tokenizedSearch_1.default)(members, (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)(debouncedSearchTerm, countryCode), function (option) { var _a, _b; return [(_a = option.text) !== null && _a !== void 0 ? _a : '', (_b = option.login) !== null && _b !== void 0 ? _b : '']; })
            : members;
        return [
            {
                title: undefined,
        ...
        selectedMembers,
        approvalWorkflow === null || approvalWorkflow === void 0 ? void 0 : approvalWorkflow.availableMembers,
        debouncedSearchTerm,
        countryCode,
        localeCompare,
