...
function RoomInvitePage(_a) {
    ...
    var _c = (0, useDebouncedState_1.default)(userSearchPhrase !== null && userSearchPhrase !== void 0 ? userSearchPhrase : ''), searchTerm = _c[0], debouncedSearchTerm = _c[1], setSearchTerm = _c[2];
    ...
    var _e = (0, OptionListContextProvider_1.useOptionsList)(), options = _e.options, areOptionsInitialized = _e.areOptionsInitialized;
