...
function BaseShareLogList(_a) {
    ...
    var defaultOptions = (0, react_1.useMemo)(function () {
        ...
        var shareLogOptions = (0, OptionsListUtils_1.getShareLogOptions)(options, betas !== null && betas !== void 0 ? betas : []);
        var header = (0, OptionsListUtils_1.getHeaderMessage)((shareLogOptions.recentReports.length || 0) + (shareLogOptions.personalDetails.length || 0) !== 0, !!shareLogOptions.userToInvite, '');
    ...
    var searchOptions = (0, react_1.useMemo)(function () {
        ...
        var filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(defaultOptions, debouncedSearchValue, countryCode, {
            preferChatRoomsOverThreads: true,
            sortByReportTypeInSearch: true,
        });
        var headerMessage = (0, OptionsListUtils_1.getHeaderMessage)((((_a = filteredOptions.recentReports) === null || _a === void 0 ? void 0 : _a.length) || 0) + (((_b = filteredOptions.personalDetails) === null || _b === void 0 ? void 0 : _b.length) || 0) !== 0, !!filteredOptions.userToInvite, debouncedSearchValue.trim());
