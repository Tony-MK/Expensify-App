...
function CopyCodesPage(_a) {
    ...
    var _g = (0, useResponsiveLayout_1.default)(), isExtraSmallScreenWidth = _g.isExtraSmallScreenWidth, isSmallScreenWidth = _g.isSmallScreenWidth;
    var _h = (0, react_1.useState)(''), error = _h[0], setError = _h[1];
    var _j = (0, useOnyx_1.default)(ONYXKEYS_1.default.ACCOUNT, { canBeMissing: true }), account = _j[0], accountMetadata = _j[1];
    ...
    var _k = (0, react_1.useState)(!isUserValidated), isValidateModalVisible = _k[0], setIsValidateModalVisible = _k[1];
