    ...
    var accountMenuItemsData = (0, react_1.useMemo)(function () {
        ...
        if (subscriptionPlan) {
            items.splice(1, 0, {
                ...
                brickRoadIndicator: !!(privateSubscription === null || privateSubscription === void 0 ? void 0 : privateSubscription.errors) || (0, SubscriptionUtils_1.hasSubscriptionRedDotError)(stripeCustomerId) ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined,
