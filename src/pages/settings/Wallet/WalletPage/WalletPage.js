...
function WalletPage(_a) {
    ...
    var _2 = _a.shouldListenForResize, shouldListenForResize = _2 === void 0 ? false : _2;
    var _3 = (0, useOnyx_1.default)(ONYXKEYS_1.default.BANK_ACCOUNT_LIST, { canBeMissing: true })[0], bankAccountList = _3 === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _3;
    var _4 = (0, useOnyx_1.default)(ONYXKEYS_1.default.CARD_LIST, { canBeMissing: true })[0], cardList = _4 === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _4;
    var _5 = (0, useOnyx_1.default)(ONYXKEYS_1.default.FUND_LIST, {
        canBeMissing: true,
        selector: function (allFunds) { return Object.fromEntries(Object.entries(allFunds !== null && allFunds !== void 0 ? allFunds : {}).filter(function (_a) {
            var _b, _c;
            var item = _a[1];
            return ((_c = (_b = item.accountData) === null || _b === void 0 ? void 0 : _b.additionalData) === null || _c === void 0 ? void 0 : _c.isP2PDebitCard) === true;
        })); },
    })[0], fundList = _5 === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _5;
    var _6 = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_LOADING_PAYMENT_METHODS, { canBeMissing: true })[0], isLoadingPaymentMethods = _6 === void 0 ? true : _6;
    var userWallet = (0, useOnyx_1.default)(ONYXKEYS_1.default.USER_WALLET, { canBeMissing: true })[0];
    var _7 = (0, useOnyx_1.default)(ONYXKEYS_1.default.WALLET_TERMS, { canBeMissing: true })[0], walletTerms = _7 === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _7;
    ...
    var _8 = (0, react_1.useContext)(DelegateNoAccessModalProvider_1.DelegateNoAccessContext), isActingAsDelegate = _8.isActingAsDelegate, showDelegateNoAccessModal = _8.showDelegateNoAccessModal;
    var _9 = (0, react_1.useContext)(LockedAccountModalProvider_1.LockedAccountContext), isAccountLocked = _9.isAccountLocked, showLockedAccountModal = _9.showLockedAccountModal;
    var isBetaEnabled = (0, usePermissions_1.default)().isBetaEnabled;
    var theme = (0, useTheme_1.default)();
    var styles = (0, useThemeStyles_1.default)();
    var translate = (0, useLocalize_1.default)().translate;
    var network = (0, useNetwork_1.default)();
    var _10 = (0, useWindowDimensions_1.default)(), windowWidth = _10.windowWidth, windowHeight = _10.windowHeight;
    var shouldUseNarrowLayout = (0, useResponsiveLayout_1.default)().shouldUseNarrowLayout;
    var _11 = (0, usePaymentMethodState_1.default)(), paymentMethod = _11.paymentMethod, setPaymentMethod = _11.setPaymentMethod, resetSelectedPaymentMethodData = _11.resetSelectedPaymentMethodData;
    var _12 = (0, react_1.useState)(false), shouldShowAddPaymentMenu = _12[0], setShouldShowAddPaymentMenu = _12[1];
    ...
    var shouldShowEnableGlobalReimbursementsButton = isBetaEnabled(CONST_1.default.BETAS.GLOBAL_REIMBURSEMENTS_ON_ND) &&
        ...
        !((_h = (_g = (_f = paymentMethod.selectedPaymentMethod) === null || _f === void 0 ? void 0 : _f.additionalData) === null || _g === void 0 ? void 0 : _g.corpay) === null || _h === void 0 ? void 0 : _h.achAuthorizationForm);
    ...
    return (<>
                            ...
                            {hasWallet && (<Section_1.default subtitle={translate("walletPage.sendAndReceiveMoney")} title={translate('walletPage.expensifyWallet')} isCentralPane subtitleMuted titleStyles={styles.accountSettingsSectionTitle} childrenStyles={shouldShowLoadingSpinner ? styles.mt7 : styles.mt5}>
                                    <>
                                        ...
                                        {!shouldShowLoadingSpinner && hasActivatedWallet && (<OfflineWithFeedback_1.default pendingAction={CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD} errors={walletTerms === null || walletTerms === void 0 ? void 0 : walletTerms.errors} onClose={PaymentMethods_1.clearWalletTermsError} errorRowStyles={[styles.ml10, styles.mr2]} style={[styles.mb2]}>
                                                <MenuItemWithTopDescription_1.default description={translate('walletPage.balance')} title={(0, CurrencyUtils_1.convertToDisplayString)((_j = userWallet === null || userWallet === void 0 ? void 0 : userWallet.currentBalance) !== null && _j !== void 0 ? _j : 0)} titleStyle={styles.textHeadlineH2} interactive={false} wrapperStyle={styles.sectionMenuItemTopDescription} copyValue={(0, CurrencyUtils_1.convertToDisplayString)((_k = userWallet === null || userWallet === void 0 ? void 0 : userWallet.currentBalance) !== null && _k !== void 0 ? _k : 0)}/>
            ...
            right: anchorPosition.anchorPositionRight,
                ...
                !shouldUseNarrowLayout
                    ? __assign(__assign({}, styles.sidebarPopover), styles.pv4) : styles.pt5,
                            ...
                            {isPopoverBottomMount && (<MenuItem_1.default title={paymentMethod.formattedSelectedPaymentMethod.title} icon={(_l = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _l === void 0 ? void 0 : _l.icon} iconHeight={(_o = (_m = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _m === void 0 ? void 0 : _m.iconHeight) !== null && _o !== void 0 ? _o : (_p = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _p === void 0 ? void 0 : _p.iconSize} iconWidth={(_r = (_q = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _q === void 0 ? void 0 : _q.iconWidth) !== null && _r !== void 0 ? _r : (_s = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _s === void 0 ? void 0 : _s.iconSize} iconStyles={(_t = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _t === void 0 ? void 0 : _t.iconStyles} description={paymentMethod.formattedSelectedPaymentMethod.description} wrapperStyle={[styles.mb4, styles.ph5, styles.pv0]} interactive={false} displayInDefaultIconColor/>)}
                ...
                (0, Modal_1.close)(function () { return setShowConfirmDeleteModal(true); });
                    ...
                    (0, Modal_1.close)(function () {
                        return Navigation_1.default.navigate(ROUTES_1.default.SETTINGS_WALLET_ENABLE_GLOBAL_REIMBURSEMENTS.getRoute(paymentMethod.selectedPaymentMethod.bankAccountID));
                    });
                }} wrapperStyle={[styles.pv3, styles.ph5, !shouldUseNarrowLayout ? styles.sidebarPopover : {}]}/>)}
                        </react_native_1.View>)}
                </Popover_1.default>
            ...
            !shouldUseNarrowLayout
                ? __assign(__assign({}, styles.sidebarPopover), styles.pv4) : styles.pt5,
                        ...
                        {isPopoverBottomMount && (<MenuItem_1.default title={paymentMethod.formattedSelectedPaymentMethod.title} icon={(_u = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _u === void 0 ? void 0 : _u.icon} iconHeight={(_w = (_v = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _v === void 0 ? void 0 : _v.iconHeight) !== null && _w !== void 0 ? _w : (_x = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _x === void 0 ? void 0 : _x.iconSize} iconWidth={(_z = (_y = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _y === void 0 ? void 0 : _y.iconWidth) !== null && _z !== void 0 ? _z : (_0 = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _0 === void 0 ? void 0 : _0.iconSize} iconStyles={(_1 = paymentMethod.formattedSelectedPaymentMethod.icon) === null || _1 === void 0 ? void 0 : _1.iconStyles} description={paymentMethod.formattedSelectedPaymentMethod.description} wrapperStyle={[styles.mb4, styles.ph5, styles.pv0]} interactive={false} displayInDefaultIconColor/>)}
