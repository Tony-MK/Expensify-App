...
function ExpensifyCardPage(_a) {
    ...
    var _v = _a.route.params.cardID, cardID = _v === void 0 ? '' : _v;
    ...
    var _w = (0, useOnyx_1.default)(ONYXKEYS_1.default.CURRENCY_LIST, { canBeMissing: true })[0], currencyList = _w === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _w;
    var pin = (0, useOnyx_1.default)(ONYXKEYS_1.default.ACTIVATED_CARD_PIN, { canBeMissing: true })[0];
    var styles = (0, useThemeStyles_1.default)();
    var isOffline = (0, useNetwork_1.default)().isOffline;
    var translate = (0, useLocalize_1.default)().translate;
    var _x = (0, react_1.useState)(false), isValidateCodeActionModalVisible = _x[0], setIsValidateCodeActionModalVisible = _x[1];
    var _y = (0, react_1.useState)(-1), currentCardID = _y[0], setCurrentCardID = _y[1];
    ...
    var _z = (0, react_1.useState)(false), isNotFound = _z[0], setIsNotFound = _z[1];
    ...
    var _0 = (0, react_1.useState)({}), cardsDetails = _0[0], setCardsDetails = _0[1];
    var _1 = (0, react_1.useState)({}), isCardDetailsLoading = _1[0], setIsCardDetailsLoading = _1[1];
    var _2 = (0, react_1.useState)({}), cardsDetailsErrors = _2[0], setCardsDetailsErrors = _2[1];
    var _3 = (0, react_1.useState)({}), validateError = _3[0], setValidateError = _3[1];
    var _4 = (0, react_1.useContext)(LockedAccountModalProvider_1.LockedAccountContext), isAccountLocked = _4.isAccountLocked, showLockedAccountModal = _4.showLockedAccountModal;
    ...
    var currency = (0, CurrencyUtils_1.getCurrencyKeyByCountryCode)(currencyList, (_p = (_o = cardsToShow === null || cardsToShow === void 0 ? void 0 : cardsToShow.at(0)) === null || _o === void 0 ? void 0 : _o.nameValuePairs) === null || _p === void 0 ? void 0 : _p.feedCountry);
    var formattedAvailableSpendAmount = (0, CurrencyUtils_1.convertToDisplayString)((_q = cardsToShow === null || cardsToShow === void 0 ? void 0 : cardsToShow.at(0)) === null || _q === void 0 ? void 0 : _q.availableSpend, currency);
    var _5 = getLimitTypeTranslationKeys((_s = (_r = cardsToShow === null || cardsToShow === void 0 ? void 0 : cardsToShow.at(0)) === null || _r === void 0 ? void 0 : _r.nameValuePairs) === null || _s === void 0 ? void 0 : _s.limitType), limitNameKey = _5.limitNameKey, limitTitleKey = _5.limitTitleKey;
    var primaryLogin = (_t = account === null || account === void 0 ? void 0 : account.primaryLogin) !== null && _t !== void 0 ? _t : '';
    var isSignedInAsDelegate = !!((_u = account === null || account === void 0 ? void 0 : account.delegatedAccess) === null || _u === void 0 ? void 0 : _u.delegate) || false;
    if (isNotFound) {
    ...
    return (<ScreenWrapper_1.default testID={ExpensifyCardPage.displayName}>
            ...
            <ValidateCodeActionModal_1.default handleSubmitForm={handleRevealDetails} clearError={function () { return setValidateError({}); }} validateError={validateError} validateCodeActionErrorField="revealExpensifyCardDetails" sendValidateCode={function () { return (0, User_1.requestValidateCodeAction)(); }} onClose={function () {
            setIsValidateCodeActionModalVisible(false);
            (0, User_1.resetValidateActionCodeSent)();
