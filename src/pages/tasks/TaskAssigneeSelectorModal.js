...
var memoizedGetValidOptions = (0, memoize_1.default)(OptionsListUtils_1.getValidOptions, { maxSize: 5, monitoringName: 'TaskAssigneeSelectorModal.getValidOptions' });
function useOptions() {
    ...
    var defaultOptions = (0, react_1.useMemo)(function () {
        var _a = memoizedGetValidOptions({
    ...
    var optionsWithoutCurrentUser = (0, react_1.useMemo)(function () {
        ...
        return __assign(__assign({}, defaultOptions), { personalDetails: defaultOptions.personalDetails.filter(function (detail) { return detail.accountID !== session.accountID; }), recentReports: defaultOptions.recentReports.filter(function (report) { return report.accountID !== session.accountID; }) });
    }, [defaultOptions, session === null || session === void 0 ? void 0 : session.accountID]);
    var options = (0, react_1.useMemo)(function () {
        var _a, _b;
        var filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(optionsWithoutCurrentUser, debouncedSearchValue.trim(), countryCode, {
            excludeLogins: CONST_1.default.EXPENSIFY_EMAILS_OBJECT,
