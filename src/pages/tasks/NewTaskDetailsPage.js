...
function NewTaskDetailsPage(_a) {
    ...
    var onSubmit = function (values) {
        ...
        if (skipConfirmation) {
            ...
            (0, Task_1.createTaskAndNavigate)(task === null || task === void 0 ? void 0 : task.parentReportID, values.taskTitle, (_a = values.taskDescription) !== null && _a !== void 0 ? _a : '', (_b = task === null || task === void 0 ? void 0 : task.assignee) !== null && _b !== void 0 ? _b : '', task.assigneeAccountID, task.assigneeChatReport, CONST_1.default.POLICY.OWNER_EMAIL_FAKE, false, quickAction);
        }
        else {
