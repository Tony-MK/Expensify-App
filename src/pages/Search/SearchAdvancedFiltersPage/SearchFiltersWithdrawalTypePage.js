...
function SearchFiltersWithdrawalTypePage() {
    ...
    const [selectedItem, setSelectedItem] = (0, react_1.useState)(searchAdvancedFiltersForm?.withdrawalType);
    const listData = (0, react_1.useMemo)(() => {
        return (0, SearchUIUtils_1.getWithdrawalTypeOptions)(translate).map((withdrawalTypeOption) => ({
    ...
    const applyChanges = (0, react_1.useCallback)(() => {
        (0, Search_1.updateAdvancedFilters)({ withdrawalType: selectedItem ?? null });
    ...
    return (<ScreenWrapper_1.default testID={SearchFiltersWithdrawalTypePage.displayName} shouldShowOfflineIndicatorInWideScreen offlineIndicatorStyle={styles.mtAuto} shouldEnableMaxHeight>
            <HeaderWithBackButton_1.default title={translate('search.withdrawalType')} onBackButtonPress={() => {
            Navigation_1.default.goBack(ROUTES_1.default.SEARCH_ADVANCED_FILTERS.getRoute());
        }}/>
