...
function SearchFiltersTaxRatePage() {
    ...
    var policyIDs = (_a = searchAdvancedFiltersForm === null || searchAdvancedFiltersForm === void 0 ? void 0 : searchAdvancedFiltersForm.policyID) !== null && _a !== void 0 ? _a : [];
    var policies = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.POLICY), {
        selector: function (allPolicies) { return (allPolicies ? Object.values(allPolicies).filter(function (policy) { return policy && policyIDs.includes(policy.id); }) : undefined); },
        canBeMissing: true,
    })[0];
