...
function SearchFiltersAssigneePage() {
    ...
    return (<ScreenWrapper_1.default testID={SearchFiltersAssigneePage.displayName} includeSafeAreaPaddingBottom shouldShowOfflineIndicatorInWideScreen offlineIndicatorStyle={styles.mtAuto} shouldEnableMaxHeight>
            <HeaderWithBackButton_1.default title={translate('common.assignee')} onBackButtonPress={() => {
            Navigation_1.default.goBack(ROUTES_1.default.SEARCH_ADVANCED_FILTERS.getRoute());
        }}/>
            <react_native_1.View style={[styles.flex1]}>
                <SearchFiltersParticipantsSelector_1.default initialAccountIDs={searchAdvancedFiltersForm?.assignee ?? []} onFiltersUpdate={(selectedAccountIDs) => {
