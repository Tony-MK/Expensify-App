...
function SearchFiltersGroupByPage() {
    ...
    const [selectedItem, setSelectedItem] = (0, react_1.useState)(searchAdvancedFiltersForm?.groupBy);
    const listData = (0, react_1.useMemo)(() => {
        return (0, SearchUIUtils_1.getGroupByOptions)().map((groupOption) => ({
    ...
    const applyChanges = (0, react_1.useCallback)(() => {
        (0, Search_1.updateAdvancedFilters)({ groupBy: selectedItem ?? null });
    ...
    return (<ScreenWrapper_1.default testID={SearchFiltersGroupByPage.displayName} shouldShowOfflineIndicatorInWideScreen offlineIndicatorStyle={styles.mtAuto} shouldEnableMaxHeight>
            <HeaderWithBackButton_1.default title={translate('search.groupBy')} onBackButtonPress={() => {
            Navigation_1.default.goBack(ROUTES_1.default.SEARCH_ADVANCED_FILTERS.getRoute());
        }}/>
