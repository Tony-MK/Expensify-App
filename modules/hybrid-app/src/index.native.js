...
var HybridAppModule = {
    ...
    signInToOldDot: function (_a) {
        var autoGeneratedLogin = _a.autoGeneratedLogin, autoGeneratedPassword = _a.autoGeneratedPassword, authToken = _a.authToken, email = _a.email, policyID = _a.policyID;
